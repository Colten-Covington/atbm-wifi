...
#include "ble_smart_cfg_lib.h"
#include "atbm_os_api.h"
#include "peer_lib.h"
#include "ble_master_demo_lib.h"
...
extern void lib_ble_thread_exit();
extern void lib_ble_main_init(void);
...
int main()
{
	...
	iot_printf("======>>atbm_ble_start>>>lib_ble_reduce_mem\n");
	lib_ble_main_init();
	while(1)
		sleep(2);
	iot_printf("======>>lib_ble_thread_exit 111\n");
	lib_ble_thread_exit();
	iot_printf("======>>lib_ble_thread_exit\n");
}
