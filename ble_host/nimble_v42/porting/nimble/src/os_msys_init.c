...
static os_membuf_t *os_msys_1_data = NULL;
...
void os_msys_init(void)
{
	...
	os_msys_1_data = atbm_kmalloc(OS_MEMPOOL_SIZE(block_count, SYSINIT_MSYS_1_MEMBLOCK_SIZE) * OS_ALIGNMENT, GFP_KERNEL);
	assert(os_msys_1_data != NULL);
