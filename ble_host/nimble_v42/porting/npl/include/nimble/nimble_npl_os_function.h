...
ble_npl_callout_remaining_ticks(struct ble_npl_callout *co,
                                ble_npl_time_t time)
{
    return npl_atbmble_npl_callout_remaining_ticks(co, time);
}
