...
#define BLE_HCI_VS_SET_PUB_ADDR   		(0x0308)
#define BLE_HCI_VS_SET_CE_TEST   		(0x0309)
	
#define BLE_HCI_VS_SCAN_FILT_CONTROL    (0x0320)
#define BLE_HCI_VS_SET_AFH_PARAM   		(0x0321)




#define BLE_HCI_VS_SET_ENH_TX_PWR       (0x0301)
