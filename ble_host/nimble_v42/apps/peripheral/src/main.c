...
adv_event(struct ble_gap_event *event, void *arg)
{
    ...
    case BLE_GAP_EVENT_ADV_COMPLETE:
        BLE_HS_LOG(INFO,"Advertising completed, termination code: %d\n",
    ...
    case BLE_GAP_EVENT_CONN_UPDATE_REQ:
        ...
        BLE_HS_LOG(INFO, "updating conncetion parameters...\n");
        event->conn_update_req.conn_handle = conn_handle;
        event->conn_update_req.peer_params = NULL;
        BLE_HS_LOG(INFO, "connection parameters updated!\n");
        break;
    case BLE_GAP_EVENT_DISCONNECT:
        ...
        break;
    default:
        BLE_HS_LOG(ERROR, "Advertising event not handled,"
                    "event code: %u\n", event->type);
        break;
    }
    return 0;
...
advertise(void)
{
    ...
    BLE_HS_LOG(INFO,"Starting advertising...\n");
...
on_reset(int reason)
{
    BLE_HS_LOG(INFO, "Resetting state; reason=%d\n", reason);
}
