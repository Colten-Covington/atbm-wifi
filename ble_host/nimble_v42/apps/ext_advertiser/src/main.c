...
start_ext_max_events_gap_event(struct ble_gap_event *event, void *arg)
{
    ...
    iot_printf("instance %u terminated\n", event->adv_complete.instance);
...
start_ext_max_events(uint8_t pattern, bool configure)
{
   ...
   /* start advertising */
    ...
    iot_printf("instance %u started (PDUs with max events %d)\n",
                                                            instance, events);
}
...
start_legacy_duration(uint8_t pattern, bool configure)
{
   ...
   /* start advertising */
    ...
    iot_printf("instance %u started (legacy PDUs with duration %d)\n",
                                                            instance, duration);
}
...
start_scannable_legacy_ext(void)
{
   ...
   /* start advertising */
    ...
    iot_printf("instance %u started (scannable legacy PDUs)\n", instance);
}
...
start_scannable_ext(void)
{
   ...
   /* start advertising */
    ...
    iot_printf("instance %u started (scannable)\n", instance);
}
...
start_non_connectable_ext(void)
{
   ...
   /* start advertising */
    ...
    iot_printf("instance %u started (non-con non-scan)\n", instance);
}
...
static void start_periodic(void)
{
    ...
    /* start advertising */
     ...
     iot_printf("instance %u started (periodic)\n", instance);
}
...
on_sync(void)
{
    ...
    iot_printf("Synced, starting advertising\n");
...
main(void)
{
    ...
    iot_printf("Extended Advertising sample application\n");
