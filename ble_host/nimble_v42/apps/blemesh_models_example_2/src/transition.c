...
void onoff_handler(struct generic_onoff_state *state)
{
	...
	ble_npl_callout_init(ptr_timer, os_eventq_dflt_get(),
...
{
	ble_npl_callout_init(&onoff_work, os_eventq_dflt_get(),
			onoff_work_handler, NULL);

	ble_npl_callout_init(&level_lightness_work, os_eventq_dflt_get(),
			level_lightness_work_handler, NULL);
	ble_npl_callout_init(&level_temp_work, os_eventq_dflt_get(),
	...
	ble_npl_callout_init(&light_ctl_work, os_eventq_dflt_get(),
			light_ctl_work_handler, NULL);
	ble_npl_callout_init(&light_ctl_temp_work, os_eventq_dflt_get(),
			light_ctl_temp_work_handler, NULL);

	ble_npl_callout_init(&dummy_timer, os_eventq_dflt_get(),
