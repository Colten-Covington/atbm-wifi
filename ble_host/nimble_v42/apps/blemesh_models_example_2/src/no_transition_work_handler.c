...
{
	ble_npl_callout_init(&no_transition_work, os_eventq_dflt_get(),
	...
	ble_npl_callout_init(&save_lightness_temp_last_values_timer,
			...
			NULL);
	ble_npl_callout_init(&unsolicitedly_publish_states_work, os_eventq_dflt_get(),
			unsolicitedly_publish_states_work_handler, NULL);
	ble_npl_callout_init(&unsolicitedly_publish_states_timer, os_eventq_dflt_get(),
