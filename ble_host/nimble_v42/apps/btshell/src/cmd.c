...
cmd_advertise_configure(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'legacy' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
       ...
       /* skip, no peer address provided */
        ...
        iot_printf("invalid 'peer_addr' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'directed' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'own_addr_type' parameter\n");
        return rc;
    }

    params.channel_map = parse_arg_uint8_dflt("channel_map", 0, &rc);
    if (rc != 0) {
        iot_printf("invalid 'channel_map' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'filter' parameter\n");
        return rc;
    }
    ...
    params.tx_power = parse_arg_long_bounds_dflt("tx_power",
                                             -127, 127, 127, &rc);
    if (rc != 0) {
        iot_printf("invalid 'tx_power' parameter\n");
        return rc;
    }
    ...
    params.primary_phy = parse_arg_kv_dflt("primary_phy", cmd_ext_adv_phy_opts,
                                           1, &rc);
    if (rc != 0) {
        iot_printf("invalid 'primary_phy' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'secondary_phy' parameter\n");
        return rc;
   }

    params.sid = parse_arg_uint8_dflt("sid", 0, &rc);
    if (rc != 0) {
        iot_printf("invalid 'sid' parameter\n");
        return rc;
    }

    rc = btshell_ext_adv_configure(instance, &params, &selected_tx_power);
    if (rc) {
        iot_printf("failed to configure advertising instance\n");
        return rc;
    }
...
cmd_advertise_set_addr(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'addr' parameter\n");
                    return rc;
    }
    ...
    if (rc) {
        iot_printf("failed to start advertising instance,rc:%d\n", rc);
        return rc;
    }
...
cmd_advertise_start(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'duration' parameter\n");
        return rc;
    }

    max_events = parse_arg_uint8_dflt("max_events", 0, &rc);
    if (rc != 0) {
        iot_printf("invalid 'max_events' parameter\n");
        return rc;
    }

    restart = parse_arg_bool_dflt("restart", 0, &rc);
    if (rc != 0) {
        iot_printf("invalid 'restart' parameter\n");
        return rc;
    }
...
cmd_advertise(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'discov' parameter\n");
        return rc;
    }
...
cmd_connect(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'extended' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'scan_interval' parameter\n");
        return rc;
    }

    phy_1M_params.scan_window = parse_arg_time_dflt("scan_window", 625, 0x0010, &rc);
    if (rc != 0) {
        iot_printf("invalid 'scan_window' parameter\n");
        return rc;
    }
    ...
    phy_1M_params.min_ce_len = parse_arg_time_dflt("min_conn_event_len", 625,
                                                   0x0010, &rc);
    if (rc != 0) {
        iot_printf("invalid 'min_conn_event_len' parameter\n");
        return rc;
    }
    ...
    phy_1M_params.max_ce_len = parse_arg_time_dflt("max_conn_event_len", 625,
                                                   0x0300, &rc);
    if (rc != 0) {
        iot_printf("invalid 'max_conn_event_len' parameter\n");
        return rc;
    }
    ...
    phy_coded_params.scan_itvl = parse_arg_time_dflt("coded_scan_interval",
                                                     625, 0x0010, &rc);
    if (rc != 0) {
        iot_printf("invalid 'coded_scan_interval' parameter\n");
        return rc;
    }
    ...
    phy_coded_params.scan_window = parse_arg_time_dflt("coded_scan_window",
                                                       625, 0x0010, &rc);
    if (rc != 0) {
        iot_printf("invalid 'coded_scan_window' parameter\n");
        return rc;
    }
    ...
    phy_coded_params.itvl_min = parse_arg_time_dflt("coded_interval_min", 1250,
                                                    ...
                                                    &rc);
    if (rc != 0) {
        iot_printf("invalid 'coded_interval_min' parameter\n");
        return rc;
    }
    ...
    phy_coded_params.itvl_max = parse_arg_time_dflt("coded_interval_max", 1250,
                                                    ...
                                                    &rc);
    if (rc != 0) {
        iot_printf("invalid 'coded_interval_max' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'coded_latency' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'coded_timeout' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'coded_min_conn_event' parameter\n");
        return rc;
    }
    ...
    phy_coded_params.max_ce_len = parse_arg_time_dflt("coded_max_conn_event",
                                                      625, 0x0300, &rc);
    if (rc != 0) {
        iot_printf("invalid 'coded_max_conn_event' parameter\n");
        return rc;
    }
    ...
    phy_2M_params.itvl_min = parse_arg_time_dflt("2M_interval_min", 1250,
                                                 ...
                                                 &rc);
    if (rc != 0) {
        iot_printf("invalid '2M_interval_min' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid '2M_interval_max' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid '2M_latency' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid '2M_timeout' parameter\n");
        return rc;
    }
    ...
    phy_2M_params.min_ce_len = parse_arg_time_dflt("2M_min_conn_event", 625,
                                                   0x0010, &rc);
    if (rc != 0) {
        iot_printf("invalid '2M_min_conn_event' parameter\n");
        return rc;
    }
    ...
    phy_2M_params.max_ce_len = parse_arg_time_dflt("2M_max_conn_event", 625,
                                                   0x0300, &rc);
    if (rc != 0) {
        iot_printf("invalid '2M_max_conn_event' parameter\n");
        return rc;
    }
...
cmd_disconnect(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'reason' parameter\n");
        return rc;
    }
...
cmd_scan(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'nodups' parameter\n");
        return rc;
    }
...
cmd_set_addr(void)
{
    ...
    case BLE_ADDR_PUBLIC:
        rc = ble_hs_vs_set_pub_addr(addr.val);
        if (rc != 0) {
            return rc;
        }
        break;
...
cmd_set(int argc, char **argv)
{
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'irk' parameter\n");
        return rc;
    }
...
static int cmd_ran_addr_gen(int argc, char **argv)
{
    int rc;
    uint8_t nrpa;
    ble_addr_t gen_addr;
	...
	nrpa = parse_arg_bool_dflt("nrpa", 0, &rc);
	if(rc != 0){
		iot_printf("err 'nrpa'\n");
	}

	rc = ble_hs_id_gen_rnd(nrpa, &gen_addr);
	if(rc == 0){
		iot_printf("random addr:");
		print_addr(gen_addr.val);
		iot_printf("\n");
	}
	else{
		iot_printf("generate err\n");
	}
	
}

#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param ran_addr_gen_params[] = {
    {"nrpa", "nrpa random addr, usage: =[0-1], default:0"},
    {NULL, NULL}
};

static const struct shell_cmd_help ran_addr_gen_help = {
    .summary = "generate a random addr",
    .usage = NULL,
    .params = ran_addr_gen_params,
};
#endif
                             ...
                             bool periodic)
{
    ...
    while (1) {
        ...
        if (rc == 0) {
            if (adv_fields.num_uuids16 >= CMD_ADV_DATA_MAX_UUIDS16) {
                iot_printf("invalid 'uuid16' parameter\n");
                return EINVAL;
            }
    ...
    if (rc != 0) {
        iot_printf("invalid 'uuids16_is_complete' parameter\n");
        return rc;
    }
    ...
    while (1) {
        ...
        if (rc == 0) {
            if (adv_fields.num_uuids32 >= CMD_ADV_DATA_MAX_UUIDS32) {
                iot_printf("invalid 'uuid32' parameter\n");
                return EINVAL;
            }
    ...
    if (rc != 0) {
        iot_printf("invalid 'uuids32_is_complete' parameter\n");
        return rc;
    }
    ...
    while (1) {
        ...
        if (rc == 0) {
            if (adv_fields.num_uuids128 >= CMD_ADV_DATA_MAX_UUIDS128) {
                iot_printf("invalid 'uuid128' parameter\n");
                return EINVAL;
            }
    ...
    if (rc != 0) {
        iot_printf("invalid 'uuids128_is_complete' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'tx_power_level' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'slave_interval_range' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'service_data_uuid16' parameter\n");
        return rc;
    }
    ...
    while (1) {
        ...
        if (rc == 0) {
            if (adv_fields.num_public_tgt_addrs >=
                ...
                iot_printf("invalid 'public_target_address' parameter\n");
                return EINVAL;
            }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'appearance' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'advertising_interval' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'service_data_uuid32' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'service_data_uuid128' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'uri' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'mfg_data' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'eddystone_measured_power' parameter\n");
        return rc;
    }
...
SRAM_CODE static int send_notify_task(void* argc)
{
	...
	int rc,cnt;
	uint8_t test_f[1000];
	iot_printf("send_notify_task timer %dms  cnt %d len %d\n", value->timer,value->cnt,value->len);
	for(i=0;i<1000;i++)
	{
		test_f[i]=i;
	}
	for(i=0;i<value->cnt;i++)
	{
		...
		if(atbm_ble_status != 3){
			iot_printf("atbm_ble_status != ATBM_BLE_STATUS_CONNECT exit atbm_ble_status=%d\n",atbm_ble_status);
			break;
		}
		cnt=0;
		while(rc && (cnt<250)&&(atbm_ble_status==3))
		{
			cnt++;
...
SRAM_CODE static int ble_sent_test(int argc, char **argv)
{
	...
	ble_tset_notify_var.timer = parse_arg_uint32("interval",&rc);

	ble_tset_notify_var.cnt = parse_arg_uint32("number",&rc);
                                            
	ble_tset_notify_var.len= parse_arg_uint32("len",&rc);
...
extern	uint8_t atbm_ble_master_status;
extern uint16_t ble_master_conn_handle;

extern SRAM_CODE int
...
SRAM_CODE static int send_write_task(void* argc)
{
	struct ble_tset_notify *value;
	value=argc;
	 int i;
	int rc,cnt;
	uint8_t test_f[1000];
	iot_printf("send_write_task timer %dms  cnt %d len %d\n", value->timer,value->cnt,value->len);
	for(i=0;i<1000;i++)
	{
		test_f[i]=i;
	}
	for(i=0;i<value->cnt;i++)
	{
		...
		rc=ble_gattc_write_flat(ble_master_conn_handle, 21,
                              test_f,value->len, ble_on_write, NULL);
		iot_printf(" send len=%d\n",value->len);
		if(atbm_ble_master_status != 3){
			iot_printf("atbm_ble_status != ATBM_BLE_STATUS_CONNECT exit atbm_ble_status=%d\n",atbm_ble_status);
			break;
		}
		cnt=0;
		while(rc && (cnt<250)&&(atbm_ble_master_status==3))
		{
			cnt++;
			iot_printf(" wait rc=%d\n",rc);
			usleep(100*1000);
...
SRAM_CODE static int ble_sent_write_test(int argc, char **argv)
{
	int rc,c;
	rc = parse_arg_all(argc - 1, argv + 1);
    if (rc != 0) {
	...
	if(ble_test_thread)
		atbm_stopThread(ble_test_thread);
	ble_test_thread = atbm_createThread(send_write_task, &ble_tset_notify_var, BLE_APP_PRIO);
	return 0;
}
static const struct shell_param ble_send_write_params[] = {
    {"len", "write send len, usage: =<UINT16>"},
    {"timer", "write Sending interval usage: =<UINT16>"},
    {"cnt", "write send number, usage: =<UINT16>"},
    {NULL, NULL}
};
static const struct shell_cmd_help send_write_help = {
    .summary = "send write",
    .usage = "Timed transmission",
    .params = ble_send_write_params,
};
...
cmd_white_list(int argc, char **argv)
{
    ...
    while (1) {
        ...
        if (rc == ENOENT) {
            ...
            iot_printf("invalid 'addr' parameter #%d\n", addrs_cnt + 1);
            return rc;
        }
...
cmd_conn_datalen(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'octets' parameter\n");
        return rc;
    }

    tx_time = parse_arg_uint16("time", &rc);
    if (rc != 0) {
        iot_printf("invalid 'time' parameter\n");
        return rc;
    }
    ...
    switch (obj_type) {
        ...
        case BLE_STORE_OBJ_TYPE_OUR_SEC:
            ...
            if (rc == 0) {
                ...
                iot_printf("invalid 'ltk' parameter\n");
                return rc;
            }
            ...
            if (rc == 0) {
                ...
                iot_printf("invalid 'csrk' parameter\n");
                return rc;
            }
...
cmd_auth_passkey(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'action' parameter\n");
        return rc;
    }
    ...
    switch (pk.action) {
        ...
        case BLE_SM_IOACT_DISP:
           ...
           if (rc != 0) {
               iot_printf("invalid 'key' parameter\n");
               return rc;
           }
           break;
        ...
        case BLE_SM_IOACT_OOB:
            ...
            if (rc != 0) {
                iot_printf("invalid 'oob' parameter\n");
                return rc;
            }
            break;
        ...
        case BLE_SM_IOACT_NUMCMP:
            ...
            if (yesno == NULL) {
                iot_printf("invalid 'yesno' parameter\n");
                return EINVAL;
            }
        ...
        case BLE_SM_IOACT_OOB_SC:
            ...
            if (rc != 0 && rc != ENOENT) {
                iot_printf("invalid 'r' parameter\n");
                return rc;
            }

            rc = parse_arg_byte_stream_exact_length("c", oob_data_remote.c, 16);
            if (rc != 0 && rc != ENOENT) {
                iot_printf("invalid 'c' parameter\n");
                return rc;
            }
        ...
        default:
            iot_printf("invalid passkey action action=%d\n", pk.action);
            return EINVAL;
    }
...
cmd_security_unpair(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'oldest' parameter\n");
        return rc;
    }

    if (oldest) {
        rc = ble_gap_unpair_oldest_peer();
        iot_printf("Unpair oldest status: 0x%02x\n", rc);
        return 0;
    }

    rc = parse_dev_addr("peer_", cmd_peer_addr_types, &peer);
    if (rc != 0) {
        iot_printf("invalid peer address\n");
        return rc;
    }
...
cmd_security_encryption(int argc, char **argv)
{
    ...
    if (rc == ENOENT) {
        ...
        if (rc != 0) {
            iot_printf("invalid 'rand' parameter\n");
            return rc;
        }

        auth = parse_arg_bool("auth", &rc);
        if (rc != 0) {
            iot_printf("invalid 'auth' parameter\n");
            return rc;
        }

        key_size = parse_arg_uint8("key_size", &rc);
        if (rc != 0) {
            iot_printf("invalid 'key_size' parameter\n");
            return rc;
        }
...
cmd_security_set_data(int argc, char **argv)
{
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'oob_flag' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'mitm_flag' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'io_capabilities' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'our_key_dist' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'their_key_dist' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'bonding' parameter\n");
        return rc;
    }
    ...
    if (rc == 0) {
        ...
        iot_printf("invalid 'sc' parameter\n");
        return rc;
    }
...
cmd_test_tx(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'stop' parameter\n");
        return rc;
    }
    ...
    if (rc != 0) {
        iot_printf("invalid 'length' parameter\n");
        return rc;
    }
    if ((len > 251) || (len < 4)) {
        iot_printf("error: len must be between 4 and 251, inclusive");
    }

    rate = parse_arg_uint16_dflt("rate", 1, &rc);
    if (rc != 0) {
        iot_printf("invalid 'rate' parameter\n");
        return rc;
    }

    num = parse_arg_uint16_dflt("num", 1, &rc);
    if (rc != 0) {
        iot_printf("invalid 'num' parameter\n");
        return rc;
    }
...
on_stop(int status, void *arg)
{
    if (status == 0) {
        ...
        iot_printf("host failed to stop; rc=%d\n", status);
    }
}
...
static const struct shell_param gatt_thou_params[] = {
    {"conn", "connection handle, usage: =<UINT16>"},
    {"attr", "attribute handle, usage: =<UINT16>"},
    {NULL, NULL}
};

static const struct shell_cmd_help gatt_thou_help = {
    .summary = "gatt thoughput test",
    .usage = NULL,
    .params = gatt_thou_params,
};
...
cmd_periodic_configure(int argc, char **argv)
{
    ...
    if (rc) {
        iot_printf("failed to configure periodic advertising\n");
        return rc;
    }

    iot_printf("Instance %u configured for periodic advertising\n",
                   instance);
...
cmd_periodic_start(int argc, char **argv)
{
    ...
    if (rc) {
        iot_printf("failed to start periodic advertising\n");
        return rc;
    }
...
cmd_periodic_stop(int argc, char **argv)
{
    ...
    if (rc) {
        iot_printf("failed to stop periodic advertising\n");
        return rc;
    }
...
cmd_sync_create(int argc, char **argv)
{
    ...
    if (argc > 1 && strcmp(argv[1], "cancel") == 0) {
        ...
        if (rc != 0) {
            iot_printf("Sync create cancel fail: %d\n", rc);
            return rc;
        }
    ...
    if (rc) {
        iot_printf("Failed to create sync (%d)\n", rc);
    }
...
cmd_sync_transfer(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'sync_handle' parameter\n");
        return rc;
    }

    service_data = parse_arg_uint16_dflt("service_data", 0, &rc);
    if (rc != 0) {
        iot_printf("invalid 'service_data' parameter\n");
        return rc;
    }
    ...
    rc = ble_gap_periodic_adv_sync_transfer(sync_handle, conn_handle,
                                            service_data);
    if (rc) {
        iot_printf("Failed to transfer sync (%d)\n", rc);
    }
...
cmd_sync_reporting(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'enabled' parameter\n");
        return rc;
    }

    rc = ble_gap_periodic_adv_sync_reporting(sync_handle, enable);
    if (rc) {
        iot_printf("Failed to %s reporting (%d)\n",
...
cmd_sync_transfer_set_info(int argc, char **argv)
{
    ...
    instance = parse_arg_uint8_dflt("instance", 0, &rc);
    if (rc != 0) {
        iot_printf("invalid 'instance' parameter\n");
        return rc;
    }
...
cmd_sync_transfer_receive(int argc, char **argv)
{
    ...
    if (rc != 0) {
        iot_printf("invalid 'disable' parameter\n");
        return rc;
    }
    ...
    if (disable) {
        ...
        if (rc) {
            iot_printf("Failed to disable sync transfer reception (%d)\n", rc);
        }
    ...
    rc = ble_gap_periodic_adv_sync_receive(conn_handle, &params, btshell_gap_event,
                                       NULL);
    if (rc) {
        iot_printf("Failed to enable sync transfer reception (%d)\n", rc);
    }
...
cmd_sync_terminate(int argc, char **argv)
{
    ...
    if (rc) {
        iot_printf("Failed to terminate sync (%d)\n", rc);
    }
...
static struct kv_pair cmd_pwr_phy_opts[] = {
    { "1M",          	0x01 },
    { "2M",          	0x02 },
    { "coded_s8",       0x03 },
    { "coded_s2",       0x04 },
...
static int cmd_enh_read_local_pwr(int argc, char **argv)
{
    int rc;
    uint16_t conn_handle;
	uint8_t phy;
	uint8_t out_status;
	uint8_t out_phy;
	uint8_t out_curr_level;
	uint8_t out_max_level;
    ...
    phy = parse_arg_kv_dflt("phy", cmd_pwr_phy_opts, 1, &rc);
    if (rc != 0) {
        iot_printf("invalid 'phy' parameter\n");
        return rc;
    }

	rc = ble_gap_enh_read_transmit_power_level(conn_handle, phy, 
											&out_status, &out_phy, &out_curr_level, &out_max_level);
    if (rc) {
        iot_printf("Failed to enh read local power level (%d)\n", rc);
    }
	else{
		if(out_status != 0){
			iot_printf("Failed to enh read local power level out_status (%d)\n", out_status);
		}
		else{
			iot_printf("out_phy:%d, out_curr_level:%d, out_max_level:%d\n", 
						out_phy, out_curr_level, out_max_level);
		}
	}
...
#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param enh_rd_local_pwr_params[] = {
	{"conn", "connection handle, usage: =<UINT16>"},
	{"phy", "phy mode for tx pwr, usage: =<UINT8>"},
	{NULL, NULL}
};

static const struct shell_cmd_help enh_rd_local_pwr_help = {
    .summary = "LE Enhanced Read Transmit Power Level",
    .usage = NULL,
    .params = enh_rd_local_pwr_params,
};
#endif

static int cmd_enh_read_remote_pwr(int argc, char **argv)
{
    int rc;
    uint16_t conn_handle;
	uint8_t phy;
	...
	rc = ble_gap_read_remote_transmit_power_level(conn_handle, phy);
    if (rc) {
        iot_printf("Failed to enh read remote power level (%d)\n", rc);
    }
...
#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param enh_rd_remote_pwr_params[] = {
	{"conn", "connection handle, usage: =<UINT16>"},
	{"phy", "phy mode for tx pwr, usage: =<UINT8>"},
	{NULL, NULL}
};

static const struct shell_cmd_help enh_rd_remote_pwr_help = {
    .summary = "LE Enhanced Read Remote Transmit Power Level",
    .usage = NULL,
    .params = enh_rd_remote_pwr_params,
};
#endif

static int cmd_set_pwr_report(int argc, char **argv)
{
    int rc;
    uint16_t conn_handle;
    ...
    local_enable = parse_arg_bool_dflt("local_enable", 0, &rc);
    if (rc != 0) {
        iot_printf("invalid 'local_enable' parameter\n");
        return rc;
    }

    remote_enable = parse_arg_bool_dflt("remote_enable", 0, &rc);
    if (rc != 0) {
        iot_printf("invalid 'remote_enable' parameter\n");
        return rc;
    }

	rc = ble_gap_set_transmit_power_reporting_enable(conn_handle, local_enable, remote_enable);
    if (rc) {
        iot_printf("Failed to set power report enable (%d)\n", rc);
    }
...
#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param set_pwr_report_params[] = {
	{"conn", "connection handle, usage: =<UINT16>"},
	{"local_enable", "Disable/Enable local transmit power reports, usage: =[0-1], default:0"},
	{"remote_enable", "Disable/Enable remote transmit power reports, usage: =[0-1], default:0"},
	{NULL, NULL}
};

static const struct shell_cmd_help set_pwr_report_help = {
    .summary = "LE Enhanced Read Transmit Power Level",
    .usage = NULL,
    .params = set_pwr_report_params,
};
#endif

static int cmd_set_path_loss_param(int argc, char **argv)
{
    int rc;
    uint16_t conn_handle;
	uint8_t high_th, high_hy, low_th, low_hy;
	...
	high_th = parse_arg_uint8("high_th", &rc);
	if (rc) {
		iot_printf("invalid 'high_th' parameter\n");
		return rc;
	}

	high_hy = parse_arg_uint8("high_hy", &rc);
	if (rc) {
		iot_printf("invalid 'high_hy' parameter\n");
		return rc;
	}

	low_th = parse_arg_uint8("low_th", &rc);
	if (rc) {
		iot_printf("invalid 'low_th' parameter\n");
		return rc;
	}

	low_hy = parse_arg_uint8("low_hy", &rc);
	if (rc) {
		iot_printf("invalid 'low_hy' parameter\n");
		return rc;
	}

	min_time_spent = parse_arg_uint16_dflt("min_time_spent", 1, &rc);
	if (rc) {
		iot_printf("invalid 'min_time_spent' parameter\n");
		return rc;
	}

	rc = ble_gap_set_path_loss_reporting_param(conn_handle, high_th, high_hy, low_th, low_hy, min_time_spent);
    if (rc) {
        iot_printf("Failed to set path loss reporting param (%d)\n", rc);
    }
...
#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param set_path_loss_params[] = {
	{"conn", "connection handle, usage: =<UINT16>"},
	{"high_th", "High threshold for the path loss (db), usage: =[0x00-0xFF]"},
	{"high_hy", "Hysteresis value for the high threshold (db), usage: =[0x00-0xFF]"},
	{"low_th", "Low threshold for the path loss (db), usage: =[0x00-0xFF]"},
	{"low_hy", "Hysteresis value for the low threshold (db), usage: =[0x00-0xFF]"},
	{"min_time_spent", "Min conn events from last report"},
	{NULL, NULL}
};

static const struct shell_cmd_help set_path_loss_help = {
    .summary = "LE Set Path Loss Reporting Parameters",
    .usage = NULL,
    .params = set_path_loss_params,
};
#endif


static int cmd_set_path_loss_report(int argc, char **argv)
{
    int rc;
    uint16_t conn_handle;
	uint8_t enable;
	...
	enable = parse_arg_bool_dflt("enable", 1, &rc);
	if (rc) {
		iot_printf("invalid 'enable' parameter\n");
		return rc;
	}

	rc = ble_gap_set_path_loss_reporting_enable(conn_handle, enable);
    if (rc) {
        iot_printf("Failed to set path loss reporting param (%d)\n", rc);
    }
...
#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param set_path_loss_rpt[] = {
	{"conn", "connection handle, usage: =<UINT16>"},
	{"enable", "enable or disable pass loss report, usage: =[0 ~ 1]"},
	{NULL, NULL}
};

static const struct shell_cmd_help set_path_loss_rpt_help = {
    .summary = "LE Set Path Loss Reporting enable",
    .usage = NULL,
    .params = set_path_loss_rpt,
};
#endif


static int cmd_set_vs_enh_pwr(int argc, char **argv)
{
    int rc;
    uint16_t conn_handle;
	int8_t pwr = 0;
	...
	tmp = parse_arg_long_bounds("pwr", -20, 10, &rc);
	if (rc == 0) {
		pwr = tmp;
	}
	else if (rc != ENOENT) {
        iot_printf("err 'rssi' parameter\n");
        return rc;
    }

	rc = ble_gap_vs_enh_set_power(conn_handle, pwr);
    if (rc) {
        iot_printf("Failed to set path loss reporting param (%d)\n", rc);
    }
...
#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param set_vs_enh_pwr_params[] = {
	{"conn", "connection handle, usage: =<UINT16>"},
	{"pwr", "power level(dbm), usage: =[-20 ~ 10]"},
	{NULL, NULL}
};

static const struct shell_cmd_help set_vs_enh_pwr_help = {
    .summary = "LE enh pwr level",
    .usage = NULL,
    .params = set_vs_enh_pwr_params,
};
#endif
...
static int cmd_set_default_subrate(int argc, char **argv)
{
	int rc;
	...
	subrate_min = parse_arg_uint16_dflt("subr_min", 1,  &rc);
    if (rc != 0) {
        iot_printf("invalid 'subr_min' parameter\n");
        return rc;
    }

	subrate_max = parse_arg_uint16_dflt("subr_max", 1,  &rc);
    if (rc != 0) {
        iot_printf("invalid 'subr_max' parameter\n");
        return rc;
    }

	max_latency = parse_arg_uint16_dflt("max_latency", 0,  &rc);
    if (rc != 0) {
        iot_printf("invalid 'max_latency' parameter\n");
        return rc;
    }

	cont_num = parse_arg_uint16_dflt("cont_num", 0,  &rc);
    if (rc != 0) {
        iot_printf("invalid 'cont_num' parameter\n");
        return rc;
    }	

	supervision_tmo = parse_arg_uint16_dflt("sup_tmo", 0xC80,  &rc);
    if (rc != 0) {
        iot_printf("invalid 'sup_tmo' parameter\n");
        return rc;
    }

	rc = ble_gap_set_default_subrate(subrate_min, subrate_max, max_latency, cont_num, supervision_tmo);
    if (rc) {
        iot_printf("Failed to default subrate (%d)\n", rc);
    }
...
#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param set_default_subrate_params[] = {
	{"subr_min", "MIN subrate factor allowed req by slave, usage: =[0x0-0x01F4], default: 0x01"},
	{"subr_max", "MAX subrate factor allowed req by slave, usage: =[0x0-0x01F4], default: 0x01"},
	{"max_latency", "MAX latency allowed req by slave, usage: =[0x0-0x01F3], default: 0x00"},
	{"cont_num", "MIN event continue num allowed req by slave, usage: =[0x0-0x01F3], default: 0x00"},
	{"sup_tmo", "MAX supervision timeout allowed req by slave, usage: =[0x0A-0x0C80], default: 0x0C80"},
	{NULL, NULL}
};

static const struct shell_cmd_help set_default_subrate_help = {
    .summary = "LE Set Default Subrate",
    .usage = NULL,
    .params = set_default_subrate_params,
};
#endif

static int cmd_subrate_req(int argc, char **argv)
{
	int rc;
	uint16_t conn_handle;
	uint16_t subrate_min;
	...
	rc = ble_gap_subrate_req(conn_handle, subrate_min, subrate_max, max_latency, cont_num, supervision_tmo);
    if (rc) {
        iot_printf("Failed to subrate req (%d)\n", rc);
    }
...
#if MYNEWT_VAL(SHELL_CMD_HELP)
static const struct shell_param subrate_req_params[] = {
	{"conn", "Connection handle, usage: =[0x0-0x0EFF]"},
	{"subr_min", "MIN subrate factor req, usage: =[0x0-0x01F4], default: 0x01"},
	{"subr_max", "MAX subrate factor req, usage: =[0x0-0x01F4], default: 0x01"},
	{"max_latency", "MAX latency req, usage: =[0x0-0x01F3], default: 0x00"},
	{"cont_num", "MIN event continue num req, usage: =[0x0-0x01F3], default: 0x00"},
	{"sup_tmo", "MAX supervision timeout req, usage: =[0x0A-0x0C80], default: 0x0C80"},
	{NULL, NULL}
};

static const struct shell_cmd_help subrate_req_help = {
    .summary = "LE Subrate Request",
    .usage = NULL,
    .params = subrate_req_params,
};
#endif
...
SRAM_CODE static int cmd_scan_chan_map_set(int argc, char **argv)
{
	uint8_t channel_map;
	int rc;
	...
	channel_map = parse_arg_uint8_dflt("channel_map", 7, &rc);
    if (rc != 0) {
        iot_printf("err 'chan_map'\n");
        return rc;
    }
	
	rc = ble_gap_set_scan_chan_map(channel_map);
	
	return rc;
}

#if (MYNEWT_VAL_SHELL_CMD_HELP)
static const struct shell_param scan_chan_map_set_params[] = {
	{"channel_map", "usage: =[0x00-0xff], default: 0x7"},
    {NULL, NULL}
};

static const struct shell_cmd_help scan_chan_map_set_help = {
    .summary = "scan channel map set, chan37-bit0 chan38-bit1 chan39-bit2",
    .usage = NULL,
    .params = scan_chan_map_set_params,
};
#endif       


static const struct kv_pair cmd_set_scan_filter_string_types[] = {
    { "hex",         CMD_SCAN_FILT_SET_CMD_HEX_STRING },
    { "str",         CMD_SCAN_FILT_SET_CMD_NORMAL_STRING },
    { NULL }
};

SRAM_CODE static int cmd_scan_filter_set(int argc, char **argv)
{
    uint8_t start_byte_index;
	uint8_t *filter_string;
    // uint8_t filter_string_len;
    bool flag_hex_string;
    int string_type;
    int rc;
    ...
    start_byte_index = (uint8_t)parse_arg_long_bounds("start_byte", 0, CMD_SCAN_FILTER_BYTE_INDEX_MAX_VALUE, &rc);
    if (rc != 0) {
        iot_printf("err 'start_byte'\n");
        return rc;
    }

    string_type = parse_arg_kv_dflt("string_type", cmd_set_scan_filter_string_types,
                                    CMD_SCAN_FILT_SET_CMD_HEX_STRING, &rc);

    filter_string = (uint8_t *)parse_arg_extract("string");
    if(filter_string == NULL){
	    iot_printf("err 'string'\n");
	    return -1;
    }
    switch (string_type) {
    case CMD_SCAN_FILT_SET_CMD_HEX_STRING: // string type is hex
        flag_hex_string = true;
        break;

    case CMD_SCAN_FILT_SET_CMD_NORMAL_STRING: // string type is string
        flag_hex_string = false;
        break;
    ...
    // filter_string_len = strlen(filter_string);
	
	rc = ble_hs_scan_filt_set(start_byte_index, flag_hex_string, filter_string);
	
	return rc;
}

#if (MYNEWT_VAL_SHELL_CMD_HELP)
static const struct shell_param scan_filter_set_params[] = {
	{"start_byte", "start byte index, usage: =<UINT8> 0 ~ 36"},
	{"string_type", "set string type, usage: =[hex|str], default: hex"},
	{"string", "expected string, usage: =[XX:XX:XX:...] or [normal_str], max octet num: 29"},
    {NULL, NULL}
};

static const struct shell_cmd_help scan_filter_set_help = {
    .summary = "set scan filter params, only report matched ADV packet to the host",
    .usage = NULL,
    .params = scan_filter_set_params,
};
#endif


SRAM_CODE static int cmd_scan_filter_clr(int argc, char **argv)
{
    int rc;    
    rc = ble_hs_scan_filt_clr();

    return rc;
}

#if (MYNEWT_VAL_SHELL_CMD_HELP)
static const struct shell_cmd_help scan_filter_clr_help = {
    .summary = "clear scan filter",
    .usage = NULL,
    .params = NULL,
};
#endif
...
SRAM_CODE static int cmd_ble_ce_test(int argc, char **argv)
{
    uint8_t enable;
	int tmp;
	int8_t rssi = 0;
	...
	if (rc != 0) {
		iot_printf("err param 'enable'\n");
		return rc;
	}


	tmp = parse_arg_long_bounds("rssi", -80, -50, &rc);
	if (rc == 0) {
		rssi = tmp;
	}
	else if (rc != ENOENT) {
	...
	rc = ble_hs_set_ce_test(enable, rssi);
	
	return rc;
}

#if (MYNEWT_VAL_SHELL_CMD_HELP)
static const struct shell_param ble_ce_set_params[] = {
	{"enable", "enable/disable ble ce test, usage: =[0 ~ 1]"},
	{"rssi",   "noise threshold, usage: =[-80 ~ -50]"},	
    {NULL, NULL}
};

static const struct shell_cmd_help ble_ce_set_help = {
    .summary = "ble ce test",
    .usage = NULL,
    .params = ble_ce_set_params,
};
#endif


SRAM_CODE static int cmd_afh_set(int argc, char **argv)
{
    uint8_t threshold;
    uint8_t period;
	int rc;
	...
	threshold = parse_arg_uint8("threshold", &rc);
	if(rc != 0 || threshold > 100){
		iot_printf("err 'threshold'\n");
		return -1;
	}

    period = parse_arg_uint8("period", &rc);
	if(rc != 0 || period > 30){
		iot_printf("err 'period'\n");
		return -1;
	}
	
	rc = ble_hs_afh_param_set(threshold, period);
	
	return rc;
}

#if (MYNEWT_VAL_SHELL_CMD_HELP)
static const struct shell_param afh_set_params[] = {
	{"threshold", "afh threshold(good packet ratio), usage: =<UINT8_T>, 0~100%"},
	{"period", "afh timer period, usage: =<UINT8_T>, 0~30s"},
    {NULL, NULL}
};

static const struct shell_cmd_help afh_set_help = {
    .summary = "afh param set",
    .usage = NULL,
    .params = afh_set_params,
};
#endif
...
static const struct shell_cmd btshell_commands[] = {
	...
	{
			.sc_cmd = "send-write",
			.sc_cmd_func = ble_sent_write_test,
#if (MYNEWT_VAL_SHELL_CMD_HELP)
			.help = &send_write_help,
#endif
	},
	{
		.sc_cmd = "ran-addr-gen",
		.sc_cmd_func = cmd_ran_addr_gen,
#if MYNEWT_VAL(SHELL_CMD_HELP)
		.help = &ran_addr_gen_help,
#endif
	},
#if !MYNEWT_VAL(BLE_EXT_ADV)
    {
	...
	{
		.sc_cmd = "gatt-thou",
		.sc_cmd_func = cmd_gatt_thoughput,
#if (MYNEWT_VAL_SHELL_CMD_HELP)
		.help = &gatt_thou_help,
#endif
	},
...
#if MYNEWT_VAL(BLE_POWER_CONTROL)
    {
       .sc_cmd = "enh_read_local_pwr",
       .sc_cmd_func = cmd_enh_read_local_pwr,
#if MYNEWT_VAL(SHELL_CMD_HELP)
       .help = &enh_rd_local_pwr_help,
#endif
    },
    {
       .sc_cmd = "enh_read_remote_pwr",
       .sc_cmd_func = cmd_enh_read_remote_pwr,
#if MYNEWT_VAL(SHELL_CMD_HELP)
       .help = &enh_rd_remote_pwr_help,
#endif
    },
    {
       .sc_cmd = "set_pwr_rpt",
       .sc_cmd_func = cmd_set_pwr_report,
#if MYNEWT_VAL(SHELL_CMD_HELP)
       .help = &set_pwr_report_help,
#endif
    },
    {
       .sc_cmd = "set_path_loss_param",
       .sc_cmd_func = cmd_set_path_loss_param,
#if MYNEWT_VAL(SHELL_CMD_HELP)
       .help = &set_path_loss_help,
#endif
    },
    {
       .sc_cmd = "set_path_loss_rpt",
       .sc_cmd_func = cmd_set_path_loss_report,
#if MYNEWT_VAL(SHELL_CMD_HELP)
       .help = &set_path_loss_rpt_help,
#endif
    },
    {
       .sc_cmd = "set_vs_enh_pwr",
       .sc_cmd_func = cmd_set_vs_enh_pwr,
#if MYNEWT_VAL(SHELL_CMD_HELP)
       .help = &set_vs_enh_pwr_help,
#endif
    },
#endif
...
#if MYNEWT_VAL(BLE_CONN_SUBRATING)
    {
       .sc_cmd = "set_default_subrate",
       .sc_cmd_func = cmd_set_default_subrate,
#if MYNEWT_VAL(SHELL_CMD_HELP)
       .help = &set_default_subrate_help,
#endif
    },
    {
       .sc_cmd = "subrate_req",
       .sc_cmd_func = cmd_subrate_req,
#if MYNEWT_VAL(SHELL_CMD_HELP)
       .help = &subrate_req_help,
#endif
    },
#endif
	...
	{
		.sc_cmd = "set-scan-chan-map",
		.sc_cmd_func = cmd_scan_chan_map_set,
#if (MYNEWT_VAL_SHELL_CMD_HELP)
		.help = &scan_chan_map_set_help,
#endif
	},

	{
		.sc_cmd = "scan-filter-set",
		.sc_cmd_func = cmd_scan_filter_set,
#if (MYNEWT_VAL_SHELL_CMD_HELP)
		.help = &scan_filter_set_help,
#endif
	},

	{
		.sc_cmd = "scan-filter-clr",
		.sc_cmd_func = cmd_scan_filter_clr,
#if (MYNEWT_VAL_SHELL_CMD_HELP)
		.help = &scan_filter_clr_help,
#endif
	},
	
	{
		.sc_cmd = "set-afh",
		.sc_cmd_func = cmd_afh_set,
#if (MYNEWT_VAL_SHELL_CMD_HELP)
		.help = &afh_set_help,
#endif
	},
	...
	{
		.sc_cmd = "ce-test",
		.sc_cmd_func = cmd_ble_ce_test,
#if (MYNEWT_VAL_SHELL_CMD_HELP)
		.help = &ble_ce_set_help,
#endif
	},
...
static struct cli_cmd_struct btShellCmds[] =
{
...
{
    cli_add_cmds(&btShellCmds[0],
		sizeof(btShellCmds)/sizeof(btShellCmds[0]));
}
