                                     ...
                                     void *arg)
{
    ...
    if (!csc_cp_indication_status) {
        BLE_HS_LOG(INFO, "SC Control Point; CCC descriptor "
    ...
    BLE_HS_LOG(INFO, "SC Control Point; opcode=%d\n", op_code);
    ...
    case SC_CP_OP_SET_CUMULATIVE_VALUE:
        ...
        BLE_HS_LOG(INFO, "SC Control Point; Set cumulative value = %d\n",
                    measurement_state->cumulative_wheel_rev);
    ...
    case SC_CP_OP_UPDATE_SENSOR_LOCATION:
        ...
        BLE_HS_LOG(INFO, "SC Control Point; Sensor location update = %d\n",
                    new_sensor_location);
...
gatt_svr_register_cb(struct ble_gatt_register_ctxt *ctxt, void *arg)
{
    ...
    case BLE_GATT_REGISTER_OP_SVC:
        BLE_HS_LOG(DEBUG, "registered service %s with handle=%d\n",
                    ble_uuid_to_str(ctxt->svc.svc_def->uuid, buf),
                    ctxt->svc.handle);
        break;

    case BLE_GATT_REGISTER_OP_CHR:
        BLE_HS_LOG(DEBUG, "registering characteristic %s with "
    ...
    case BLE_GATT_REGISTER_OP_DSC:
        BLE_HS_LOG(DEBUG, "registering descriptor %s with handle=%d\n",
