...
enum atbm_crystal_type{
	ATBM_INDIPENT_CRYSTAL,
	ATBM_SHARE_CRYSTAL = 2,
};
...
typedef struct
{
    ...
    unsigned int BW; //channel bandwidth  
...
/* AFactor 
HE-SIG-A2 subfield of HE-SIG-A field, B13鈥揃14, Pre-FEC Padding Factor
...
#define RFIP_CRONUS_MCS_LUT_BASE_ADDR	(0x0ACBE000)
#define RFIP_MCS_LUT_BASE_ADDR			(0x0ACBD510)
...
typedef struct
{
    ...
    unsigned int TxStreams : 2; //N_sts of Artemis doc; TxStreams of Cronus doc
 ...
 */    
    ...
    unsigned int ChOffset : 3; //not used in Leto
...
int atbm_internal_get_start_rx_results(struct atbm_common *hw_priv,u32 *rx_status_success,u32 
*rx_status_error);
