...
/*WSM interface changed, add Enc header*/
#ifndef CIPHER_HIF_COMBINED
#define CIPHER_HIF_COMBINED
#endif

#ifdef CIPHER_HIF_COMBINED
#define HW_INSERT_DUMMY			BIT(15)
#define ENC_DATA_LEN_MASK		0x3fff

#define ENC_CMD_ENCRYPT				BIT(0)
#define ENC_CMD_DECRYPT				BIT(1)
#define CHKSUM_ENABLE				BIT(2)
#define CHKSUM_ENABLE_OPT			BIT(3)
#define CHKSUM_ENABLE_ICMP			BIT(4)
#define ENC_INTERFACE_OFFSET		9
#define ENC_INTERFACE_MASK			(0x7<<ENC_INTERFACE_OFFSET)
#define MAC_HEADER_OFFSET_OFFSET	12
#define MAC_HEADER_OFFSET_MASK		(0x3f<<MAC_HEADER_OFFSET_OFFSET)
#define ENC_FORCE_PROTECT			BIT(20)
#define ENC_FORCE_PROTECT_MGMT		BIT(21)
#define ENC_PROTECT_AUTH			BIT(22)
#define ENC_ENABLE_11W				BIT(23)
...
#define WSM_TRANSMIT_RATE_HE_MCSER0		(23)
#define WSM_TRANSMIT_RATE_HE_MCSER1		(24)
#define WSM_TRANSMIT_RATE_HE_MCSER2		(25)

#define WSM_TRANSMIT_RATE_HE_MCS0		(26)
#define WSM_TRANSMIT_RATE_HE_MCS1		(27)
#define WSM_TRANSMIT_RATE_HE_MCS2		(28)
#define WSM_TRANSMIT_RATE_HE_MCS3		(29)
#define WSM_TRANSMIT_RATE_HE_MCS4		(30)
#define WSM_TRANSMIT_RATE_HE_MCS5		(31)
#define WSM_TRANSMIT_RATE_HE_MCS6		(32)
#define WSM_TRANSMIT_RATE_HE_MCS7		(33)
#define WSM_TRANSMIT_RATE_HE_MCS8		(34)
#define WSM_TRANSMIT_RATE_HE_MCS9		(35)
#define WSM_TRANSMIT_RATE_HE_MCS10		(36)
#define WSM_TRANSMIT_RATE_HE_MCS11		(37)


#define WSM_TRANSMIT_RATE_VHT_MCS0          	38
#define WSM_TRANSMIT_RATE_VHT_MCS1          	39
#define WSM_TRANSMIT_RATE_VHT_MCS2          	40
#define WSM_TRANSMIT_RATE_VHT_MCS3          	41
#define WSM_TRANSMIT_RATE_VHT_MCS4          	42
#define WSM_TRANSMIT_RATE_VHT_MCS5          	43
#define WSM_TRANSMIT_RATE_VHT_MCS6          	44
#define WSM_TRANSMIT_RATE_VHT_MCS7          	45
#define WSM_TRANSMIT_RATE_VHT_MCS8          	46
#define WSM_TRANSMIT_RATE_VHT_MCS9          	47
...
#define WSM_FLAG_ENABLE_RADAR (BIT(7))
...
#define WSM_HT_TX_MODE				(BIT(0)|BIT(1))//mix,notht,greenfile
#define WSM_HT_TX_SGI				(BIT(2))
#define WSM_HT_TX_WIDTH_40M			(BIT(3))
#define WSM_HT_TX_USE_FIXED_RATE	(BIT(4))
#define WSM_HT_TX_LONG_PREAMBLE		(BIT(5))
/* STBC allowed */
#define WSM_HT_TX_STBC			(BIT(7))
#define WSM_NEED_TX_CONFIRM		(BIT(8))
#define WSM_HT_AGGR_EN			(BIT(9))
#define WSM_HT_NEED_SEQ			(BIT(10))
#define WSM_TX_HT_LDPC				(BIT(11))
#define WSM_NEED_TX_RATE_CONFIRM		(BIT(12))


#define WSM_TX_RATE_CHANGED	(BIT(13))


/*he param*/
#define WSM_TX_HE_HTC					(BIT(0))
/*
bit [2:1]
00: 1x
01: 2x
10: 4x
*/
#define WSM_TX_HE_LTF_2X				(BIT(1))
#define WSM_TX_HE_LTF_4X				(BIT(2))
/*
GI[4:3]
00:0.8 us
01:1.6 us
10:3.2 us
*/
#define WSM_TX_HE_GI_16				(BIT(3))
#define WSM_TX_HE_GI_32				(BIT(4))
#define WSM_TX_HE_DCM_USED			(BIT(5))
#define WSM_TX_HE_NORM_PAD8			(BIT(6))
#define WSM_TX_HE_NORM_PAD16		(BIT(7))
#define WSM_TX_HE_LDPC				(BIT(8))
#define WSM_TX_HE_ER_106			(BIT(9))
#define WSM_TX_HE_SMPDU				(BIT(10))

#define WSM_TX_HE_SUPPORT_DCM	    (BIT(11))   //support DCM, LMAC can set DCM flag.
#define WSM_TX_HE_DOWN_TO_11B       (BIT(12))
...
#define WSM_RX_STATUS_8023_FRAME	(BIT(30))
...
/* Key indexes */
#define ATBMWIFI_WSM_KEY_MAX_INDEX	(20)
#define WSM_KEY_MAX_INDEX		(20)
...
#define WSM_ASSOCIATION_MODE_USE_HE_MODE			(BIT(5))
#define WSM_ASSOCIATION_MODE_USE_SHORT_BA_WINDOW	(BIT(6)) //addba windows = 32 , not set this flag windows=  64
...
#define WSM_MIB_ID_SET_REKEY_DATA			0x2000
...
#define WSM_MIB_ID_GET_SNR						0x1062 //int sRxEvm = 0;
#define WSM_MIB_ID_GET_WIN_TXPOWER     			0x1065
#define WSM_MIB_ID_SET_PRE_COMPENSATION			0x1066

#define WSM_MIB_ID_SET_TEMP_DCXO_TABLE			0x1068
#define WSM_MIB_ID_RX_RATE_AVERAGE				0x1069
// Add for #7070
#define WSM_MIB_ID_GET_TX_PARAMETER				0x106a
// Add for oceanus requirement latency l2
#define WSM_MIB_ID_GET_TX_LATENCY				0x106b
#define WSM_MIB_ID_TX_TXBW20M_USE_20UL			0x106c
#define WSM_MIB_ID_TX_TARGET_POWER_CONFIG		0x106d //Oceanus /cronuslite 使用配置文件 set_rate_power.txt调节发送功率
#define WSM_MIB_ID_TX_HOST_CTRL_DELTAGAIN_AND_TPC 0x106e
#define WSM_MIB_ID_TARGET_POWER_THRESHOLD 		0x106f //REDUCE_TX_POWER_CONSUMPTION max tx power =15dBm
#define WSM_MIB_ID_REDUCE_TX_RX_POWER_CONSUMPTION 	0x1070 //tx rx power consumption
#define WSM_MIB_ID_USR_TX_DELTA_GAIN_CONFIG 	0x1071 //set user tx delta gain into fw

#define WSM_MIB_ID_SET_2ANT_EXTRA_IO	    0x1074
#define WSM_MIB_ID_GET_2ANT_EXTRA_IO	    0x1075

#define WSM_MIB_ID_SET_LIGHTSLEEP_INFO 			0x1076
#define WSM_MIB_ID_SET_LIGHTSLEEP_START 	    0x1077

#define WSM_MIB_ID_SET_BSS_COLOR		0x2002
#define WSM_MIB_ID_SET_SR_OBSS_PD		0x2003

#define WSM_MIB_ID_MAC_RESET			0x3000
#define WSM_MIB_ID_TWT					0x3001
#define WSM_MIB_ID_SET_DCM              0x3002
#define WMS_MIB_ID_UPDATE_BSS_LOST_COUNTER 0x3003
...
#define WSM_BLE_IND_ADV_RPT					0
#define WSM_BLE_IND_CONN_RPT				1
...
struct wsm_hdr_tx {
	union{
		...
		}common;//sdio used this ,when wsm usb also used this, in hwusb change to  usb_hdr
		struct{
			__le32 flag;//hw flag
			__le16 usb_len;
			__le16 usb_id;
		}usb_hdr;//usb used this
	}u;
    struct hw_enc_hdr enc_hdr;
	__le16 len;
	__le16 id;
}__packed;
...
#define WSM_TX_LINK_ID_MAX		(0x0B)
...
#define WSM_CMD_FLUSH_TIMEOUT (HZ * 10)

#define WSM_CMD_LAST_CHANCE_TIMEOUT (HZ * 40)
#define WSM_CMD_EXTENDED_TIMEOUT (HZ * 20 / 2)

#define WSM_RI_GET_PEER_ID_FROM_FLAGS(_f)         (((_f)&(0xF<<25)>>25))

#define WSM_SUPPORT_RATE_FLAGS__ENABLE_HT      BIT(0)
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_VHT     BIT(1)
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_HE      BIT(2)
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_40M     BIT(3)
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_5G      BIT(4)
/* ******************************************************************** */
struct wsm_supp_rate{
    __le16 flags; 
    u8     if_id;
    u8     peer_id;
    __le32 supp_rates;       
...
#define HW_CHIP_VERSION_Cronus			(0x5A)
#define HW_CHIP_VERSION_Oceanus_FM 		(0x30)
#define HW_CHIP_VERSION_Cronus_Lite_FM 	(0x5C)
...
#define WSM_SCAN_REQ_RADAR_DETECT BIT(0)
...
#if  1  //(OLD_RATE_POLICY==0)


	/* WSM_TRANSMIT_RATE_RETRY... */
      union{
    /* [in] */ u32 txRateSets;  /*other rate and rate mode selected*/
	/* [in] */ u8 TxRateRetry[4];
        };
...
struct wsm_join {
	...
	/*[in]*/	u8  transbssid[6];
	/*[in]*/	u16 bssid_index;
	/*[in]*/	u8  max_bssid_index;
	/*[in]*/	u8  wifi4_option;
	/*[in]*/	u8  not_support_multi_bssid;
	/*[in]*/	u8  is_trans_bssid;
...
/**
 * enum atbm_he_pkt_ext_constellations - PPE constellation indices
 * @ATBM_HE_PKT_EXT_BPSK: BPSK
 * @ATBM_HE_PKT_EXT_QPSK:  QPSK
 * @ATBM_HE_PKT_EXT_16QAM: 16-QAM
 * @ATBM_HE_PKT_EXT_64QAM: 64-QAM
 * @ATBM_HE_PKT_EXT_256QAM: 256-QAM
 * @ATBM_HE_PKT_EXT_1024QAM: 1024-QAM
 * @ATBM_HE_PKT_EXT_RESERVED: reserved value
 * @ATBM_HE_PKT_EXT_NONE: not defined
 */
enum atbm_he_pkt_ext_constellations {
	ATBM_HE_PKT_EXT_BPSK = 0,
	ATBM_HE_PKT_EXT_QPSK,
	ATBM_HE_PKT_EXT_16QAM,
	ATBM_HE_PKT_EXT_64QAM,
	ATBM_HE_PKT_EXT_256QAM,
	ATBM_HE_PKT_EXT_1024QAM,
	ATBM_HE_PKT_EXT_RESERVED,
	ATBM_HE_PKT_EXT_NONE,
};

#define MAX_HE_SUPP_NSS	1
#define MAX_HE_CHANNEL_BW_INDX	4

/**
 * struct atbm_he_pkt_ext - QAM thresholds
 ...
 *		(0-low_th, 1-high_th)
 */
struct atbm_he_pkt_ext {
	u8 pkt_ext_qam_th[MAX_HE_SUPP_NSS][MAX_HE_CHANNEL_BW_INDX][2];
} __packed; /* PKT_EXT_DOT11AX_API_S */

//he_support_flag
#define F_HE_SUPPORT_ENABLE		BIT(0)
#define F_HE_COLOR_ENABLE		BIT(1)
#define F_HE_UORA_ENABLE		BIT(2)
#define F_HE_MUL_BSSID_ENABLE	BIT(3)
#define F_HE_MUL_PACKET_EXT		BIT(4)
#define F_HE_SU_4XLTF_08US		BIT(5)
#define F_HE_ER_4XLTF_08US		BIT(6)
#define F_HE_1XLTF_08US		BIT(7)



//htc_flags
#define F_HTC_SUPPORT_HE_ENABLE		BIT(0)
#define F_HTC_SUPPORT_BSR_ENABLE	BIT(1)
#define F_HTC_SUPPORT_OMI_ENABLE	BIT(2)
#define F_HTC_SUPPORT_BQR_ENABLE	BIT(3)
struct wsm_set_bss_params {
	...
	u8 color;
	u8 uora_ocw_range;/*ecwmin bit0~bit2: ecwmax bit3~bit5*/
	...
	struct atbm_he_pkt_ext pkt_ext;
...
struct wsm_mu_edca_queue_params
{
	/* AIFS (in slots) for the access class. */
	/* [in] */ u8 aifns;
    /* CWmin/CWmax */
...
struct wsm_edca_params {
    ...
    u32 mu_edca;   
    struct wsm_mu_edca_queue_params mu_params[4];
};
...
#define WSM_MU_EDCA_SET(edca, queue, aifsn, ecw_min_max, mu_edca_timer)\
	do {							\
		struct wsm_mu_edca_queue_params *p = &(edca)->mu_params[queue]; \
		p->ecw_min_max = (ecw_min_max);				\
		p->aifns = (aifsn);				\
		p->mu_edca_timer = (mu_edca_timer);		\
	} while (0)
...
#define WSM_START_FLAGS_HE_ENABLE	BIT(0)
struct wsm_start {
	/* WSM_START_MODE_... */
	/* [in] */ u8 mode;
...
struct wsm_map_link {
	...
	/* [in] */ u8 mfp;		
               u8 rev[3];
    struct wsm_supp_rate supp_rate;
};
...
int wsm_req_rx_ba_session(struct atbm_common *hw_priv,struct wsm_rx_ba_session *arg,int if_id);

/* ******************************************************************** */
/* MIB shortcats							*/
static inline int wsm_set_dcm_enable(struct atbm_common *hw_priv,u32 dcm_state,int if_id)
{ 
    __le32 _dcm_state = __cpu_to_le32(dcm_state);

    return wsm_write_mib(hw_priv,WSM_MIB_ID_SET_DCM,&_dcm_state,sizeof(u32),if_id);
}
static inline int wsm_set_update_bss_lost_counter(struct atbm_common *hw_priv,u8 counter,int if_id)
{
    return wsm_write_mib(hw_priv,WMS_MIB_ID_UPDATE_BSS_LOST_COUNTER,&counter,1,if_id); 
}
...
static inline int wsm_get_tx_lifetime(struct atbm_common *hw_priv,void *tx_parameter,int len)
{
	return wsm_read_mib(hw_priv, WSM_MIB_ID_GET_TX_PARAMETER, tx_parameter,
				len, -1);
}
...
struct light_sleep_info{
	unsigned char 	token[6];
	unsigned char 	ap1MacAddress[6];
	unsigned char 	ap2MacAddress[6];
	unsigned char 	ap3MacAddress[6];
	unsigned char 	ap4MacAddress[6];
	unsigned char 	notifyWakeupGpioNum;
	unsigned char 	buttonStateAndWakeupVaule;
	unsigned char 	wakeupTypeGpioNum;
	unsigned char 	lostCnt;
	unsigned short 	wakeTimeMs;
	unsigned int 	sleepTimeMs;
	unsigned int 	channel;
};

static inline int wsm_set_lightsleep_info(struct atbm_common *hw_priv,void *data,int len)
{
	return wsm_write_mib(hw_priv, WSM_MIB_ID_SET_LIGHTSLEEP_INFO, data,
				len, -1);
}

static inline int wsm_set_lightsleep_start(struct atbm_common *hw_priv,void *data,int len)
{
	return wsm_write_mib(hw_priv, WSM_MIB_ID_SET_LIGHTSLEEP_START, data,
				len, -1);
}
...
/*TWT*/
#define WSM_TWT_FLAGS_ENABLE_TWT	BIT(0)
#define WSM_TWT_FLAGS_TRIGGER		BIT(1)
#define WSM_TWT_FLAGS_IMPLICIT		BIT(2)
#define WSM_TWT_FLAGS_FLOW_TYPE		BIT(3)
...
{
	return wsm_write_mib(hw_priv, WSM_MIB_ID_SET_REKEY_DATA,arg, sizeof(*arg),if_id);
}
#endif
...
int atbm_cronus_wsm_set_rate_power(struct atbm_common *hw_priv);
void wsm_force_free_tx(struct atbm_common	*hw_priv,struct wsm_tx *wsm);


#ifdef CIPHER_HIF_COMBINED
int wsm_txrx_data_test(struct atbm_common *hw_priv,	int len, int interval, int multis, int rx_len, int if_id);
int wsm_check_txrx_data(struct atbm_common *hw_priv,				void *arg,				struct wsm_buf *buf);
#endif
#ifdef CIPHER_HIF_COMBINED
u8 wsm_checksum_u8(u8 *p, int len);
#endif
#ifdef ATBM_TEST_ERROR_DEBUG
struct wsm_txrx_err_debug{
...
int wsm_ble_msg_coexist_start(struct atbm_common *hw_priv, const struct wsm_ble_msg_coex_start *arg, int if_id);
int wsm_ble_msg_coexist_stop(struct atbm_common *hw_priv, const struct wsm_ble_msg *arg, int if_id);
int wsm_ble_msg_set_adv_data(struct atbm_common *hw_priv, const struct wsm_ble_msg_adv_data *arg, int if_id);
...
#define WSM_CSA_FLAGS_START BIT(0)
...
#define WSM_CSA_REQ_ID 0x002a
#define WSM_CSA_RESP_ID 0x042a
int wsm_csa_req(struct atbm_common *hw_priv, const struct wsm_csa *arg,
		int if_id);

#define WSM_CSA_REQ_CONCURRENT_ID  0x002b
#define WSM_CSA_RESP_CONCURRENT_ID 0x042b
#define WSM_CSA_REQ_CONCURRENT_MAX 2

struct wsm_csa_concurrent_vif{
	u8  if_id;
	u8  chantyep;
	u16 channel;
};
struct wsm_csa_concurrent
{
	struct wsm_csa_concurrent_vif vifs[WSM_CSA_REQ_CONCURRENT_MAX];
};
...
#define TEMP_DCXO_ELEMENTS_MAX	14
struct atbm_temp_dcxo_table{
	s16 temp_table[TEMP_DCXO_ELEMENTS_MAX];
	s16 delta_dcxo_table[TEMP_DCXO_ELEMENTS_MAX];
};
int wsm_set_temp_dcxo_table(struct atbm_common *hw_priv, struct atbm_temp_dcxo_table *ptemp_dcxo_table, int if_id);
