...
//#endif
   ...
   ATBM_DEV_IO_GET_STA_INFO_NEW     = 49,
	ATBM_DEV_IO_SET_RATE_ALL_POWER  = 50,
	ATBM_DEV_IO_SET_BEST_CHANNEL_SCAN2 = 51,
	ATBM_DEV_IO_SET_BEST_CHANNEL_SCAN3 = 52,
	ATBM_DEV_IO_SEND_PROBE_REQ      = 53,
	ATBM_DEV_IO_GET_TX_PKT_STATUS      = 54,
	ATBM_DEV_IO_SET_BEACON_LOSS_CNT      = 55,
#ifdef ATBM_USE_FASTLINK
		ATBM_DEV_IO_RESET_FASTLINK		= 56,
#endif
	ATBM_DEV_IO_SET_AMPDU      = 57,
	ATBM_DEV_IO_SET_SINGLE_SCAN_TIME      = 58,
	ATBM_DEV_IO_GET_NOISE_LEVEL      = 59,
	ATBM_DEV_IO_GET_SNR      = 60,
	ATBM_DEV_IO_GET_CCA_THRESHOLD		= 61,
	ATBM_DEV_IO_SET_CCA_THRESHOLD		= 62,
	
	ATBM_DEV_IO_GET_RTS_THRESHOLD		= 63,
	ATBM_DEV_IO_SET_RTS_THRESHOLD		= 64,
	ATBM_DEV_IO_GET_TX_POWER_TABLE		= 65,
	ATBM_DEV_IO_SET_TEMP_DCXO_TABLE		= 66,
	ATBM_DEV_IO_GET_CHIP_TEMPATURE		= 67,
	ATBM_DEV_IO_SET_TXPWR_SINGLE        = 68,
	ATBM_DEV_IO_SET_BEST_CHANNEL_SCAN_OPTIONAL = 69,
	ATBM_DEV_IO_SET_SCAN_CHANNEL_LIMIT   = 70,
};

#define WSM_MAX_NUM_LINK_AP 16//Lmac support station number is 4;
...
typedef struct _atbm_wifi_tx_power_info_{
    int function_index;
	int mode;
	int rate;
	int bw;
	int power;
}atbm_wifi_tx_power_info;
