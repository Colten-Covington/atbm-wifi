...
extern struct atbm_rate_control_ops mac80211_ratectrl;
...
#define TEST_ON_FIXED_RATE 1 //cw500 
/*
...
#define FULL_DILE_SET_20M_THRESH 50
#define LITE_CHIP_FLAG           6  //oceanous&cronus lite
...
enum ATBM_CHIP_CATEGORY{
	ATBM_CRONUS_CATEGORY,
	ATBM_OCEANUS_CATEGORY,
	ATBM_CLITE_CATEGORY
};

struct sta_cap{
       struct atbm_ieee80211_sta_ht_cap       ht_cap;
...
u8  sucess_probs[RATE_CONTROL_RATE_NUM]; // sucess probability *256
    ...
    s8  bw_40m_cnt;
    u8  bw_not_update_cnt;
    u8  phy_cfg;
    u16 rx_idle_ratio_update_cnt;
    u16 last_rx_idle_ratio_update_cnt;
...
//#endif
    u16 tx_ratio;             //lite
	u16 main_snd_idle_ratio; //cronus
    u16 snd_idle_ratio;
	u16 main_idle_ratio;
	...
	u32 tx_pkts_count_period;
	u32 tx_real_eval_rates;
	unsigned long tx_pkt_count_update_time;
	u32 total_tx_counter;
	u32 total_tx_fail_counter;
	u32 received_num;
	u32 rx_rate_avg;
...
#define RATE_INDEX_VHT_MCS0             38
#define RATE_INDEX_VHT_MCS1             39
#define RATE_INDEX_VHT_MCS2             40
#define RATE_INDEX_VHT_MCS3             41
#define RATE_INDEX_VHT_MCS4             42
#define RATE_INDEX_VHT_MCS5             43
#define RATE_INDEX_VHT_MCS6             44
#define RATE_INDEX_VHT_MCS7             45
#define RATE_INDEX_VHT_MCS8             46
#define RATE_INDEX_VHT_MCS9             47


/*LMAC  HMAC  convert used, be compatible with cronus, refer to convert table */
#define DESCR_RATE_INDEX_VHT_MCS9        2
#define DESCR_RATE_INDEX_VHT_MCS8        3
#define DESCR_RATE_INDEX_VHT_MCS7        4
#define DESCR_RATE_INDEX_VHT_MCS6        5
#define DESCR_RATE_INDEX_VHT_MCS5        6
#define DESCR_RATE_INDEX_VHT_MCS4        7
#define DESCR_RATE_INDEX_VHT_MCS3        8
#define DESCR_RATE_INDEX_VHT_MCS2        9
#define DESCR_RATE_INDEX_VHT_MCS1        10
#define DESCR_RATE_INDEX_VHT_MCS0        11
