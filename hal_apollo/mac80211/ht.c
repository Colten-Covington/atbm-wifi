...
void ieee80211_ht_cap_adjust_by_customer(struct ieee80211_hw *hw,struct ieee80211_sub_if_data *sdata)
{
    ...
    for (i = 0; i < IEEE80211_NUM_BANDS; i++){
        ...
        case 0:
            cap &= ~(IEEE80211_HT_CAP_SUP_WIDTH_20_40 | IEEE80211_HT_CAP_SGI_40 | IEEE80211_HT_CAP_DSSSCCK40);	
            break;
        case 1:
            cap |=  IEEE80211_HT_CAP_SUP_WIDTH_20_40 | IEEE80211_HT_CAP_SGI_40;
...
void ieee80211_sta_tear_down_tx_BA_sessions(struct sta_info *sta, bool tx)
{
	int i;
			     ...
			     struct atbm_ieee80211_mgmt *mgmt, size_t len)
{
	...
	if (initiator == WLAN_BACK_INITIATOR)
		...
		__ieee80211_stop_tx_ba_session(sta, tid, WLAN_BACK_RECIPIENT,
					       true);
        /*
         * reinit the addba limit
         */
        spin_lock_bh(&sta->lock);
		ratelimit_state_init(&sta->ampdu_mlme.trylimit[tid],HT_AGG_TX_INTREVAL,HT_AGG_TX_BURST);
        spin_unlock_bh(&sta->lock);
    }
}
