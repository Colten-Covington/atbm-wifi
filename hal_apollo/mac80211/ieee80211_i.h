...
#define IEEE80211_ENCRYPT_HEADROOM 40
...
struct ieee802_atbm_11_elems {
	...
	struct atbm_ieee80211_ht_info *ht_info_elem;
	...
	//wifi6 IE
	const u8 *he_cap;
	const struct atbm_ieee80211_mu_edca_param_set *mu_edca_param_set;
//#ifdef CONFIG_ATBM_HE
	const struct atbm_ieee80211_he_operation *he_operation;
	const struct atbm_ieee80211_he_spr *he_spr;
	const struct atbm_ieee80211_vht_cap *vht_cap_elem;	
	const struct atbm_ieee80211_vht_operation *vht_operation;
	const struct atbm_ieee80211_he_6ghz_capa *he_6ghz_capa;
	const struct atbm_ieee80211_multiple_bssid_configuration *mbssid_config_ie;	
	const struct atbm_ieee80211_bssid_index *bssid_index;
	const struct atbm_ieee80211_aid_response_ie *aid_resp;
	const struct atbm_ieee80211_addba_ext_ie *addba_ext_ie;
	const struct atbm_ieee80211_bss_max_idle_period_ie *max_idle_period_ie;
...
#define IEEE80211_MAX_SUPP_RATES 32
	...
	u8 max_bssid_indicator;
	u64 timestamp;
	unsigned long timestamp_update;
...
enum ieee80211_packet_rx_flags {
	...
	IEEE80211_RX_MUCAST_DATA        = BIT(8),
};
...
enum ieee80211_csa_mlme_state{
	IEEE80211_CSA_MLME_STATE_IDLE,
	IEEE80211_CSA_MLME_STATE_STOP,
	IEEE80211_CSA_MLME_STATE_WK,
	IEEE80211_CSA_MLME_STATE_START,
	IEEE80211_CSA_MLME_STATE_TIMEOUT,
	IEEE80211_CSA_MLME_STATE_FAIL,
	IEEE80211_CSA_MLME_STATE_FINISHED,
};

struct ieee80211_csa_mlme {

	enum ieee80211_csa_mlme_state state;
	/*
	...
	*use for csa
	*/
	struct beacon_data __rcu *csa_beacon;
	/*
	*use for csa after
	*/
	struct beacon_data __rcu *beacon_after;

#ifdef ATBM_PROBE_RESP_EXTRA_IE
	struct proberesp_data __rcu *csa_proberesp;
	struct proberesp_data __rcu *proberesp_after;
#endif
	bool block_tx;
	u8 count;
...
enum ieee80211_work_type {
	IEEE80211_WORK_ABANDON,
	IEEE80211_WORK_ABORT,
	IEEE80211_WORK_DIRECT_PROBE,
	IEEE80211_WORK_AUTH,
	IEEE80211_WORK_ASSOC_BEACON_WAIT,
	IEEE80211_WORK_ASSOC,
	IEEE80211_WORK_REASSOC,
	IEEE80211_WORK_REMAIN_ON_CHANNEL,
	IEEE80211_WORK_OFFCHANNEL_TX,
	IEEE80211_WORK_CONNECTTING,
	IEEE80211_WORK_DISCONNECTTING,
	IEEE80211_WORK_HE_AP,
#ifdef CONFIG_ATBM_STA_DYNAMIC_PS
	IEEE80211_WORK_PS_RECAL,
#endif
	IEEE80211_WORK_FLUSH_STA,
	IEEE80211_WORK_DHCP,
	IEEE80211_WORK_NETQ,
	IEEE80211_WORK_EVENT,
	IEEE80211_WORK_OM,
	IEEE80211_WORK_BSS_IDLE,
	IEEE80211_WORK_TWT,
	IEEE80211_WORK_TWT_SUSPEND,
	IEEE80211_WORK_CANCLE_WORK,
	IEEE80211_WORK_CSA_NOTIFY,
	IEEE80211_WORK_DELIVER_SAE,
    IEEE80211_WORK_CONN,
    IEEE80211_WORK_CHAN_ASYNC,
    IEEE80211_WORK_VHT_ACTION,
	/*
	*keep must
	*/
	IEEE80211_WORK_MAX,
...
struct ieee80211_work {
	...
	enum work_done_result (*done)(struct ieee80211_work *wk,
				      struct sk_buff *skb);
	enum work_action (*start)(struct ieee80211_work *wk);
	enum work_action (*rx)(struct ieee80211_work *wk,struct sk_buff *skb);
	enum work_action (*tx)(struct ieee80211_work *wk,struct sk_buff *skb);
	bool (*filter)(struct ieee80211_work *wk,struct sk_buff *skb);
	u16 filter_fc;
	struct ieee80211_channel *chan;
	enum nl80211_channel_type chan_type;
	enum ieee80211_chan_mode chan_mode;
	
	unsigned long timeout;
	enum ieee80211_work_type type;

	u8 filter_bssid[ETH_ALEN];
	u8 filter_sa[ETH_ALEN];
	bool started;
	...
	union {
		...
		struct {
            struct atbm_ieee80211_vht_cap vht_cap;
			struct cfg80211_bss *bss;
			const u8 *supp_rates;
		...
		struct {
			int tries;
			int retry_max;
			struct ieee80211_twt_request_params twt;
		}twt_request;
		struct {
			enum ieee80211_sta_twt_suspend_state state;
		}twt_suspend;
		struct {
			enum ieee80211_work_type type;
		}work_cancle;
...
enum ieee80211_sae_authen_state{
	IEEE80211_LOCAL_COMMIT  = BIT(0),
	IEEE80211_LOCAL_CONFIRM = BIT(1),
	IEEE80211_PEAR_COMMIT   = BIT(2),
	IEEE80211_PEAR_CONFIRM  = BIT(3),
};

enum ieee80211_sae_state{
    IEEE80211_SAE_NOTHING,
    IEEE80211_SAE_COMMITTED,
    IEEE80211_SAE_CONFIRMED,
    IEEE80211_SAE_ACCEPTED,
};
enum ieee80211_conn_state
{
    IEEE80211_CONN_IDLE,
    IEEE80211_CONN_CHAN_ASYNC,
    IEEE80211_CONN_JOIN,
    IEEE80211_CONN_AUTHENTICATE_NEXT,
    IEEE80211_CONN_AUTHENTICATING,
    IEEE80211_CONN_AUTHEN_FAILED_TIMEOUT,
    IEEE80211_CONN_ASSOCIATE_NEXT,
    IEEE80211_CONN_ASSOCIATING,
    IEEE80211_CONN_ASSOC_FAILED,
    IEEE80211_CONN_ASSOC_FAILED_TIMEOUT,
    IEEE80211_CONN_PRE_ABANDON,
    IEEE80211_CONN_ABANDON,
    IEEE80211_CONN_CONNECTED,
};
struct ieee80211_mgd_auth_req
{
    struct cfg80211_bss __rcu *bss;
	struct ieee80211_channel *chan;
    int tries;
    int sae_authen_state;
    u16 algorithm, transaction;
    u8 bssid[ETH_ALEN];
    u8 ssid[IEEE80211_MAX_SSID_LEN];
	u8 ssid_len;
...
struct ieee80211_mgd_assoc_req
{
    struct cfg80211_bss *bss;
	struct ieee80211_channel *chan;
    int tries;
	...
	enum ieee80211_smps_mode smps;
    struct atbm_ieee80211_vht_cap vht_cap;
	struct atbm_ieee80211_ht_info ht_info;
    size_t ie_len;
    u8 ie[];
};
struct ieee80211_conn{
    enum ieee80211_conn_state state;
    struct cfg80211_bss *bss;
    struct ieee80211_mgd_auth_req *auth_req;
    struct ieee80211_mgd_assoc_req *assoc_req;
    struct sk_buff *skb;
    int tries;
    bool pending;
    bool running;
    ...
    size_t len;
    volatile struct ieee80211_work *work;
};
...
struct ieee80211_if_managed {
    ...
    struct ieee80211_conn conn;
	struct mutex mtx;
	struct cfg80211_bss *associated;
	struct probe_request_extra __rcu *probe_request_extra;
    enum ieee80211_sae_state sae_state;
	int sae_state_bit;
	u8 bssid[ETH_ALEN];
	u8 transmitter_bssid[ETH_ALEN];
	u8 b_notransmit_bssid;
	u16 aid;
...
#define IEEE80211_SCAN_POLICY_USER_CHANNEL	0
#define IEEE80211_SCAN_POLICY_2_4G			1
#define IEEE80211_SCAN_POLICY_5G_ON_IR		2
#define IEEE80211_SCAN_POLICY_5G_IR			3

#define IEEE80211_SCAN_POLICY_MAX			4

struct ieee80211_scan_policy_requset;

enum scan_policy_results{
	SCAN_POLICY_RESULTS_OK,
	SCAN_POLICY_RESULTS_SKIP,
	SCAN_POLICY_RESULTS_FINISHED,
};
enum scan_policy_action{
	SCAN_POLICY_ACTION_INIT,
	SCAN_POLICY_ACTION_PREPARE_CHANNEL,
	SCAN_POLICY_ACTION_PREPARE_RX,
};
struct ieee80211_scan_policy
{
	struct list_head list;
	u16  band;
	u16  rev;
	unsigned long channel_unmap[BITS_TO_LONGS(256)];
	enum scan_policy_results (*func)(struct ieee80211_scan_policy_requset *request);
};
...
struct ieee80211_sub_if_data {
	...
	struct atbm_work_struct color_change_finalize_work;

	struct atbm_ieee80211_tx_queue_params tx_conf[IEEE80211_NUM_ACS];
	...
	*8023
	*/
	struct sk_buff_head skb_deliver;
	...
	u32 fastlink_enable;
	u8 associated_mac[6];
	u8 associated_ssid[32];
	u32 associated_ssid_len;
	bool is_fast_associated;
	u32 fast_chan_switch;
#endif
struct ieee80211_scan_policy scan_policy[IEEE80211_SCAN_POLICY_MAX];
#ifdef CONFIG_ATBM_SUPPORT_GRO
	struct napi_struct napi_rx;
	struct sk_buff_head napi_rx_list;
	bool   napi_enable;
	unsigned long napi_trace[65];
#endif
	/*
	*wmm
	*/
	...
	*csa state;
	*/
	enum ieee80211_csa_mlme_state csa_state;
	struct atbm_timer_list csa_timer;
#endif
	u8 bSupport40M;
#ifdef  CONFIG_SUPPORT_80M_ADAPTER
	u8 bSupport40M_Next;
	u8 bSupport40M_Fix;
	u32 highthrouputRateCnt;
	u32 last_tx_num;
	u32 last_rx_num;
	unsigned long last_80M_adapter_time;
	u8	last_bssid[ETH_ALEN];
#endif //#ifdef  CONFIG_SUPPORT_80M_ADAPTER

	struct ieee80211_vif vif;
};

struct ieee80211_sta_hdr {
	struct ieee80211_key *key;
	u8 hdr_len;
	u8 sa_offs, da_offs, pn_offs;
	u8 band;
	u8 icv_len;
	u8 hdr[30 + 2 + 18 + sizeof(rfc1042_header)] __aligned(2);
	
	struct rcu_head rcu_head;
};
struct ieee80211_scan_policy_requset{
	enum scan_policy_action action;
	struct ieee80211_sub_if_data *sdata;
...
enum ieee80211_sdata_queue_mlme
{
    MLME_CHANNEL_ASYNC_NOTIFY,
    MLME_REQ_PROCESS,
};
enum sdata_queue_type {
	IEEE80211_SDATA_QUEUE_TYPE_FRAME	= 0,
	IEEE80211_SDATA_QUEUE_SEND_STATUS   = 1,
	IEEE80211_SDATA_QUEUE_CSA		    = 2,
	IEEE80211_SDATA_QUEUE_FLUSH			= 3,
    IEEE80211_SDATA_QUEUE_ACTION        = 4,
    IEEE80211_SDATA_QUEUE_MLME          = 5,
};
...
enum queue_stop_reason {
	IEEE80211_QUEUE_STOP_REASON_REV,
	IEEE80211_QUEUE_STOP_REASON_DRIVER,
	IEEE80211_QUEUE_STOP_REASON_PS,
	IEEE80211_QUEUE_STOP_REASON_CSA,
	IEEE80211_QUEUE_STOP_REASON_AGGREGATION,
	IEEE80211_QUEUE_STOP_REASON_AGGREGATION_PENDING,
	IEEE80211_QUEUE_STOP_REASON_SUSPEND,
	IEEE80211_QUEUE_STOP_REASON_SKB_ADD,
	IEEE80211_QUEUE_STOP_REASON_CHTYPE_CHANGE,
	IEEE80211_QUEUE_STOP_REASON_FLUSH_DRIVER,
};
...
enum ieee80211_internal_scan_flags{
	...
	IEEE80211_INTERNAL_SCAN_FLAGS__ETF_REQUEST     = BIT(5),
	IEEE80211_INTERNAL_SCAN_FLAGS__UPDATE_BSS	   = BIT(6),
	IEEE80211_INTERNAL_SCAN_FLAGS__RADAR_DETECT     = BIT(7),
};
...
struct ieee80211_internal_scan_notity{
	...
	struct ieee80211_radar_exist radar;
};
...
struct ieee80211_internal_channel_auto_select_results{
	...
	u8 best_channel_flag;
	u8 conn_ap_mac[6];
	u8 susgest_3_channel[3];

	u8 ap_ssid[32];
	AP_BASIC_INFO apInfo[13];
	u8 apInfo_num;

	u8 susgest_channel;
	u8 susgest_24g_channel;
	u8 susgest_5g_channel;
	u8 version;
};
...
struct atbm_ieee80211_addba_ext_ie {
	u8 data;
} __packed;
...
enum ieee80211_ble_thread_action{
	THREAD_ACTION_WAKEUP,
	THREAD_ACTION_SHOULD_SUSPEND,
	THREAD_ACTION_SUSPENED,
	THREAD_ACTION_SHOULD_STOP,
};

struct ieee80211_ble_thread
{
	const char *name;
	...
	int (*thread_fn)(struct ieee80211_ble_thread *thread);
	int (*period_handle)(struct ieee80211_ble_thread *thread);
	struct ieee80211_local *local;
};

struct ieee80211_ble_local{
	bool ble_started;
	spinlock_t  ble_spin_lock;
	struct mutex	ble_mutex_lock;
	int  (*ble_recv_callback)(struct platform_device *pble_dev, struct sk_buff *skb);
	struct sk_buff_head ble_xmit_queue;
	struct sk_buff_head ble_recv_queue;
	struct ieee80211_ble_thread recv_thread;
	struct ieee80211_ble_thread xmit_thread;
};

struct  ieee80211_ble_buff{
	struct sk_buff *skb;
	u8 mem[0] __attribute__((__aligned__(64)));
};
#endif

enum ieee80211_csa_state {
	CSA_IDLE,
	CSA_WAIT_START,
	CSA_WAIT_COMPLETE,
};
...
struct ieee80211_local {
	...
	struct list_head work_pending_list;
...
#define IEEE80211_IRQSAFE_QUEUE_LIMIT 128
	...
	unsigned int hw_scan_ies_bufsize;
	bool   worker_working;
...
//#endif
	int channel_2_4G_start;
	int channel_2_4G_end;
	int channel_5G_start;
	int channel_5G_end;
...
#define I802_DEBUG_INC(c) do { } while (0)
	...
	*/
	...
	bool ext_wfa_test_flag;
	u8 ext_capa[8];
#ifdef CONFIG_ATBM_BLE
	struct platform_device ble_dev;
	struct ieee80211_ble_local ble_local;
#endif
#ifdef CONFIG_ATBM_SUPPORT_CSA
	struct atbm_work_struct  csa_work;
	enum ieee80211_csa_state  next_csa_state;
	struct list_head csa_req;
	struct list_head csa_pending;
    struct list_head csa_notify;
#endif
#ifdef CONFIG_ATBM_RADAR_DETECT
#if LINUX_VERSION_IS_GEQ_OR_CPTCFG(3, 9, 0)
	struct atbm_work_struct radar_detected_work;
	struct cfg80211_chan_def dfs_cac_chan_def;
	struct ieee80211_sub_if_data *cac_sdata;
	struct cfg80211_chan_def cac_detect_chan_def;
#endif
#endif
	u32 dummy_insert_failcnt;
};
...
#ifdef CONFIG_ATBM_SUPPORT_P2P
/* off-channel helpers */
void  ieee80211_roc_purge_current(struct ieee80211_local *local);
...
void ieee80211_work_work(struct atbm_work_struct *work);
...
ieee80211_tx_result ieee80211_work_tx_mgmt(struct ieee80211_sub_if_data *sdata,
					   struct sk_buff *skb);
bool ieee80211_work_tx_default_filter(struct ieee80211_work *wk,struct sk_buff *skb);
bool ieee80211_work_rx_default_filter(struct ieee80211_work *wk,struct sk_buff *skb);
...
void ieee80211_dfs_radar_detected_work(struct atbm_work_struct *work);
...
ieee80211_he_op_ie_to_bss_conf(struct ieee80211_vif *vif,
			const struct atbm_ieee80211_he_operation *he_op_ie_elem);
...
void ieee80211_ht_cap_adjust_by_customer(struct ieee80211_hw *hw,struct ieee80211_sub_if_data *sdata);
...
#endif  //CONFIG_ATBM_HE
u8 *ieee80211_ie_build_vht_cap(u8 *pos, struct atbm_ieee80211_sta_vht_cap *vht_cap,u32 cap);
...
void ieee80211_assign_sta_hdr(struct sta_info *sta);
void ieee80211_clear_sta_hdr(struct sta_info *sta);
void ieee80211_assign_sta_hdr_iface(struct ieee80211_sub_if_data *sdata);
void ieee80211_sta_work(struct ieee80211_sub_if_data *sdata);
void ieee80211_sdata_queue_mlme_process(struct ieee80211_sub_if_data *sdata,struct sk_buff *skb);
#ifdef CONFIG_ATBM_SUPPORT_GRO
int ieee80211_rx_napi_poll(struct napi_struct *napi,int budget);
void ieee80211_sdata_napi_sched(struct ieee80211_sub_if_data *sdata,struct sk_buff *skb);

#endif
void ieee80211_rx_sendto_monitor(struct ieee80211_sub_if_data *sdata,struct sk_buff *skb);
void ieee80211_conn_purge(struct ieee80211_sub_if_data *data);
#ifdef CONFIG_ATBM_BLE
...
void ieee80211_ble_fw_reset_dev_deregister(struct ieee80211_local *local);
...
void ieee80211_sdata_csa_completed_notify(struct ieee80211_sub_if_data *sdata);
extern void __ieee80211_recalc_dcm(struct ieee80211_local *local);
extern void ieee80211_recalc_dcm(struct ieee80211_local *local);
#if (LINUX_VERSION_IS_GEQ_OR_CPTCFG(3,12,0)) ||(CONFIG_ATBM_LOW_KERNEL_SUPPORT_CSA == 1)
