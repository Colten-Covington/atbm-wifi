					...
					size_t len)
{
	 ...
	 */
	if (auth_alg == ATBM_WLAN_AUTH_OPEN && auth_transaction == 1)
		ieee80211_send_auth(sdata, 2, ATBM_WLAN_AUTH_OPEN, 0, NULL, 0,
				     ...
				     struct ieee80211_rx_status *rx_status)
{
	...
	ieee802_11_parse_elems(mgmt->u.beacon.variable, len - baselen, false, &elems, mgmt->bssid, NULL);
