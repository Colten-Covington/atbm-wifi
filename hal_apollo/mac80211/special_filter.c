...
#if 0		
			if(ieee80211_send_mgmt_to_wpa_supplicant(sdata,skb) == 0){
				atbm_printk_err("send probe req to wpa_supplicant success !! \n");
			}else{
				atbm_printk_err("send probe req to wpa_supplicant fail !! \n");
			}
#endif
