...
static int share_cfo_allow = 0; 
void atbm_set_cfo_allow_flag(int allow)
{
	share_cfo_allow = allow;
}

int atbm_get_cfo_allow_flag(void)
{
	return share_cfo_allow;
}
...
#ifndef ATBM_ADD_CRERT_FIRMWARE
	if(wifi_bt_comb==2)
		return 0;
#endif  //ATBM_ADD_CRERT_FIRMWARE
	return wifi_bt_comb;
}
#ifdef SDIO_BUS
static int bus_awake = 0;
#else
static int bus_awake = 1;
#endif
module_param(bus_awake,int,0644);
...
static char chip_mac_str[32]={0xff,0};

module_param_string(chip_mac, chip_mac_str,32, 0644);
...
int vht_sgi = 2;//0 long-gi , 1 sgi, 2 auto
module_param(vht_sgi, int, 0644);

int vht_ldpc = 2;//0 bcc , 1 ldpc, 2 auto
module_param(vht_ldpc, int, 0644);
...
int beamforming_on = 1;//0:fixed rate no rate success static , 1. fixed rate have rate success static
...
int chan_width = 0;
#endif
module_param(chan_width, int, 0644);
...
int ht_vht_not_40M = 0xff;
module_param(ht_vht_not_40M, int, 0644);

/*manual debug gi set
rate_for_gi: mcs0:mcs11, default set 0xff(not used)
hi_rate_gi: 3,4
low_rate_gi:1,3
1> 4x3.2
2> 4x0.8
...
module_param(rate_for_gi, int, 0644);
int hi_rate_gi = 0xff;
module_param(hi_rate_gi, int, 0644);
int low_rate_gi = 0xff;
module_param(low_rate_gi, int, 0644);
...
module_param(wifi_special_freq, int, 0644);
...
int atbm_80M_adapter = 1;/*1 is lmac ; 2 is hmac; 3 is lmac & hmac, 0 is disable*/
module_param(atbm_80M_adapter, int, 0644);
...
static struct ieee80211_rate atbm_rates[] = {
	RATETAB_ENT(10,  0,   0,0/*IEEE80211_RATE_HW_FLAGS_UNMAP*/),
	RATETAB_ENT(20,  1,   0,0/*IEEE80211_RATE_HW_FLAGS_UNMAP*/),
	RATETAB_ENT(55,  2,   0,0/*IEEE80211_RATE_HW_FLAGS_UNMAP*/),
...
static struct ieee80211_rate atbm_mcs_rates[] = {
	RATETAB_ENT(65,  14, ATBM_IEEE80211_TX_RC_MCS,0),
	RATETAB_ENT(130, 15, ATBM_IEEE80211_TX_RC_MCS,0),
	RATETAB_ENT(195, 16, ATBM_IEEE80211_TX_RC_MCS,0),
	RATETAB_ENT(260, 17, ATBM_IEEE80211_TX_RC_MCS,0),
	RATETAB_ENT(390, 18, ATBM_IEEE80211_TX_RC_MCS,0),
	RATETAB_ENT(520, 19, ATBM_IEEE80211_TX_RC_MCS,0),
	RATETAB_ENT(585, 20, ATBM_IEEE80211_TX_RC_MCS,0),
	RATETAB_ENT(650, 21, ATBM_IEEE80211_TX_RC_MCS,0),
	RATETAB_ENT(60 , 22, ATBM_IEEE80211_TX_RC_MCS,0),
};

static struct ieee80211_rate atbm_he_mcs_rates[] = { 
    RATETAB_ENT(75,  23, ATBM_IEEE80211_TX_RC_HE_MCS,0), //ER-MCS0   
    RATETAB_ENT(146,  24, ATBM_IEEE80211_TX_RC_HE_MCS,0),//ER-MCS1 
    RATETAB_ENT(219,  25,ATBM_IEEE80211_TX_RC_HE_MCS ,0),//ER-MCS2 
    RATETAB_ENT(75,  26, ATBM_IEEE80211_TX_RC_HE_MCS,0),//MCS0
    RATETAB_ENT(146, 27, ATBM_IEEE80211_TX_RC_HE_MCS,0),//MCS1
    RATETAB_ENT(219, 28, ATBM_IEEE80211_TX_RC_HE_MCS,0),//MCS2
    RATETAB_ENT(293, 29, ATBM_IEEE80211_TX_RC_HE_MCS,0),//MCS3
    RATETAB_ENT(439, 30, ATBM_IEEE80211_TX_RC_HE_MCS,0),
    RATETAB_ENT(585, 31, ATBM_IEEE80211_TX_RC_HE_MCS,0),
    RATETAB_ENT(658, 32, ATBM_IEEE80211_TX_RC_HE_MCS,0),
    RATETAB_ENT(731, 33, ATBM_IEEE80211_TX_RC_HE_MCS,0),
    RATETAB_ENT(878, 34, ATBM_IEEE80211_TX_RC_HE_MCS,0),
    RATETAB_ENT(975, 35, ATBM_IEEE80211_TX_RC_HE_MCS,0),
    RATETAB_ENT(1097, 36, ATBM_IEEE80211_TX_RC_HE_MCS,0),
    RATETAB_ENT(1219, 37, ATBM_IEEE80211_TX_RC_HE_MCS,0), //MCS11    
};
...
struct atbm_ieee80211_sta_vht_cap atbm_support_2g4_vht_cap = 
{
   .vht_supported = true,
   .cap = ATBM_IEEE80211_VHT_CAP_MAX_MPDU_LENGTH_3895 |
       ATBM_IEEE80211_VHT_CAP_RXLDPC |	
       ATBM_IEEE80211_VHT_CAP_RXSTBC_1 |
       ATBM_IEEE80211_VHT_CAP_TXSTBC |
       ATBM_IEEE80211_VHT_CAP_SU_BEAMFORMER_CAPABLE |
       ATBM_IEEE80211_VHT_CAP_SU_BEAMFORMEE_CAPABLE |
       ATBM_IEEE80211_VHT_CAP_HTC_VHT |
       (1 << ATBM_IEEE80211_VHT_CAP_BEAMFORMEE_STS_SHIFT)| 
       /*IEEE80211_VHT_CAP_MAX_A_MPDU_LENGTH_EXPONENT_MASK |*/
#ifdef SDIO_BUS
       (2 << ATBM_IEEE80211_VHT_CAP_MAX_A_MPDU_LENGTH_EXPONENT_SHIFT) |
#else
   ...
   .vht_mcs = {
       ...
       cpu_to_le16(ATBM_IEEE80211_VHT_MCS_SUPPORT_0_8 << 0 |
#else
       cpu_to_le16(ATBM_IEEE80211_VHT_MCS_SUPPORT_0_9 << 0 |
#endif
...
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
#ifdef CONFIG_ATBM_VHT
struct atbm_ieee80211_sta_vht_cap atbm_support_5g_vht_cap = 
{
   .vht_supported = true,
   .cap = ATBM_IEEE80211_VHT_CAP_MAX_MPDU_LENGTH_3895 |
       ATBM_IEEE80211_VHT_CAP_RXLDPC |	
...
static void atbm_bus_keep_awake(struct atbm_common *hw_priv)
{
    if(bus_awake)
...
#endif
static int atbm_do_change_dcm(struct ieee80211_hw *hw)
{
	struct atbm_common *hw_priv = hw->priv;
    ...
    return wsm_set_dcm_enable(hw_priv,(u32)(hw->dcm_enable),0);
}
...
#endif
    .do_change_dcm = atbm_do_change_dcm,
};
#ifdef CONFIG_PM
...
void atbm_get_mac_address(struct atbm_common *hw_priv)
{
	...
	if(atbm_access_file(PATH_WIFI_MACADDR,readmac,17,1) > 0) {
	...
	if(chip_mac_str[0] != 0xff){
		atbm_printk_err("wlan0 mac0:%s \n",chip_mac_str);
		
		sscanf(chip_mac_str,"%2X:%2X:%2X:%2X:%2X:%2X",
								(int *)&hw_priv->addresses[0].addr[0],
								(int *)&hw_priv->addresses[0].addr[1],
								(int *)&hw_priv->addresses[0].addr[2],
								(int *)&hw_priv->addresses[0].addr[3],
		...
		atbm_printk_err("wlan0 mac1:%s \n",chip_mac_str);
		snprintf(chip_mac_str,32,"%2X:%2X:%2X:%2X:%2X:%2X",
...
struct ieee80211_hw *atbm_init_common(size_t hw_priv_data_len)
{
...
#ifdef CONFIG_ATBM_VHT
	    hw->vht_cap_2g4 = &atbm_support_2g4_vht_cap;
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
	    hw->vht_cap_5g  = &atbm_support_5g_vht_cap;
#endif
#endif
	...
	hw->queues = 4;
#endif
    hw->max_scan_channels_support = WSM_SCAN_MAX_NUM_OF_CHANNELS;
	hw_priv->noise = -94;
    ...
    if(vht_ldpc == 0){
#ifdef CONFIG_ATBM_VHT
        atbm_support_2g4_vht_cap.cap &= ~(ATBM_IEEE80211_VHT_CAP_RXLDPC);
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
        atbm_support_5g_vht_cap.cap &= ~(ATBM_IEEE80211_VHT_CAP_RXLDPC);
#endif
#endif
	...
	if (ht_sgi)
	{
		...
		if (atbm_band_2ghz.ht_cap.cap &  IEEE80211_HT_CAP_SUP_WIDTH_20_40)
			atbm_band_2ghz.ht_cap.cap |=  IEEE80211_HT_CAP_SGI_40;
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
        atbm_band_5ghz.ht_cap.cap |=  IEEE80211_HT_CAP_SGI_20;
		if (atbm_band_5ghz.ht_cap.cap &  IEEE80211_HT_CAP_SUP_WIDTH_20_40)
			atbm_band_5ghz.ht_cap.cap |=  IEEE80211_HT_CAP_SGI_40;
		if (atbm_band_5ghz.ht_cap.cap &  IEEE80211_HT_CAP_SUP_WIDTH_20_40)
			atbm_band_5ghz.ht_cap.cap |=  IEEE80211_HT_CAP_SGI_40;
...
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
		atbm_band_5ghz.ht_cap.cap &=  ~(IEEE80211_HT_CAP_SGI_20|IEEE80211_HT_CAP_SGI_40);
#endif
	}
	if (stbc)
	{
...
#ifdef CONFIG_ATBM_VHT
        atbm_support_2g4_vht_cap.cap &= ~ATBM_IEEE80211_VHT_CAP_RXSTBC_1;
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
        atbm_support_5g_vht_cap.cap &= ~ATBM_IEEE80211_VHT_CAP_RXSTBC_1;
#endif
#endif
#ifdef CONFIG_ATBM_HE
       atbm_support_he_cap.he_cap_elem.phy_cap_info[2] &= ~ATBM_IEEE80211_HE_PHY_CAP2_STBC_RX_UNDER_80MHZ;
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
       atbm_support_5g_he_cap.he_cap_elem.phy_cap_info[2] &= ~ATBM_IEEE80211_HE_PHY_CAP2_STBC_RX_UNDER_80MHZ;
#endif
#endif
	}
...
#if 0 //move to probe function,because this function we can't read regiter, not know chipid
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
#if defined (CONFIG_ATBM_5G_PRETEND_2G)
		hw->wiphy->bands[IEEE80211_BAND_5GHZ] = &atbm_band_5ghz;
	wiphy_apply_custom_regulatory(hw->wiphy,&atbm_request_regdom);
		atbm_printk_always("enable 5G beacuse 5G_PRETEND_2G\n");
#else // (CONFIG_ATBM_5G_PRETEND_2G)
		if(hw_priv->chip_cat == OCEANUS_CATEGORY){
			hw->wiphy->bands[IEEE80211_BAND_5GHZ] = &atbm_band_5ghz;
			wiphy_apply_custom_regulatory(hw->wiphy,&atbm_request_regdom);
		}
		else {
			atbm_printk_always("disable 5G beacuse cronus not support\n");
		}
	
#endif // (CONFIG_ATBM_5G_PRETEND_2G)
#endif /* CONFIG_ATBM_APOLLO_5GHZ_SUPPORT */
#endif //
...
//#endif //#ifdef CONFIG_WIRELESS_EXT
	...
	atbm_tcpack_offload_init(hw_priv);
...
void atbm_unregister_common(struct ieee80211_hw *dev)
{
	...
	hw_priv->init_done = 0;
#ifdef CONFIG_TCP_ACK_OFFLOAD
	atbm_tcpack_offload_deinit(hw_priv);
#endif //#ifdef CONFIG_TCP_ACK_OFFLOAD
...
static void atbm_set_ifce_comb(struct atbm_common *hw_priv,
				 struct ieee80211_hw *hw)
{
	...
	hw_priv->if_combs[0].radar_detect_widths =	BIT(NL80211_CHAN_WIDTH_20_NOHT) |
				BIT(NL80211_CHAN_WIDTH_20) |
				BIT(NL80211_CHAN_WIDTH_40),
	hw_priv->if_combs[1].num_different_channels = 1;
	hw_priv->if_combs[1].radar_detect_widths =	BIT(NL80211_CHAN_WIDTH_20_NOHT) |
				BIT(NL80211_CHAN_WIDTH_20) |
				BIT(NL80211_CHAN_WIDTH_40),
	hw_priv->if_combs[2].num_different_channels = 1;
	hw_priv->if_combs[2].radar_detect_widths =	BIT(NL80211_CHAN_WIDTH_20_NOHT) |
				BIT(NL80211_CHAN_WIDTH_20) |
				BIT(NL80211_CHAN_WIDTH_40),
#endif
#endif
...
int atbm_cronus_get_rate_delta_gain(char *src_file, int *dst)
{
	...
	if(!readbuf){
		atbm_printk_err("readbuf malloc error! \n");
		return -1;
	}
	...
	if((readnum = atbm_access_file(src_file,readbuf,1024,1)) > 0)
	{
		pdata[count] = readbuf;
		count++;
...
int atbm_get_rate_delta_gain(char *src_file, int *dst)
{
	int i=0,count = 0,readnum=0,val = 0;
	char *readbuf;
	char *pdata[100] = {NULL};
	...
	readbuf = atbm_kmalloc(2048, GFP_KERNEL);
	if(!readbuf){
		atbm_printk_err("readbuf malloc error! \n");
		return -1;
	}
	...
	if((readnum = atbm_access_file(src_file,readbuf,2048,1)) > 0)
	{
		pdata[count] = readbuf;
		count++;
...
void atbm_get_delta_gain(char *srcData,int *allgain)
{
	int i=0,count = 0,readnum=0,val = 0;
	char *pdata[40] = {NULL};
	char *pstr = NULL;
		      ...
		      struct atbm_common **pself)
{
	...
	FUNC_ENTER();
	if(atbm_access_file(PATH_WIFI_PSM_INFO,buffer,2,1) > 0) {
		if(buffer[0] == 0x30) {
...
reload_fw:
	...
	atbm_set_ifce_comb(hw_priv, dev);
...
//fix mstar CVT suspend bug,in CVT mstar suspend wait_event_interruptible_timeout sometime will not delay
	{
		...
		chip_flag = atbm_efuse_read_chip_flag(hw_priv);	
	
	   /*check lmac capability based on efuse setting
		  firmwareCap is not chip flag, processed in lmac */
	   if((chip_flag & BIT(0)) || ((hw_priv->chip_cat == OCEANUS_CATEGORY)||(hw_priv->chip_cat == CLITE_CATEGORY)) )//((hw_priv->wsm_caps.firmwareCap &CAPABILITIES_CHIP_FLAG))
	   {
...
#ifdef CONFIG_ATBM_HE				
				atbm_support_he_cap.he_cap_elem.phy_cap_info[0] &= ~ATBM_IEEE80211_HE_PHY_CAP0_CHANNEL_WIDTH_SET_40MHZ_IN_2G;
#endif				
			...
			if((hw_priv->wsm_caps.firmwareExCap &EXCAPABILITIES_WIFI6)==0)//not support wifi6
			{
				if((hw_priv->chip_cat == OCEANUS_CATEGORY)||(hw_priv->chip_cat == CLITE_CATEGORY)){
#ifdef CONFIG_ATBM_HE					
					hw_priv->hw->he_cap_2g4 = NULL;
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)

					hw_priv->hw->he_cap_5g = NULL;

#endif  //#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT)
#endif

					atbm_printk_init("LMAC NOT SUPPORT WiFi6 !!!\n");
				}
			}

	   }
	   //
	   ///check this chip is support 5GHZ
	   //
#if defined (CONFIG_ATBM_APOLLO_5GHZ_SUPPORT) || defined (CONFIG_ATBM_5G_PRETEND_2G)
#if defined (CONFIG_ATBM_5G_PRETEND_2G)
			hw_priv->hw->wiphy->bands[IEEE80211_BAND_5GHZ] = &atbm_band_5ghz;
			wiphy_apply_custom_regulatory(hw_priv->hw->wiphy,&atbm_request_regdom);
			atbm_printk_always("=>enable 5G beacuse 5G_PRETEND_2G\n");
#else // (CONFIG_ATBM_5G_PRETEND_2G)
			if(hw_priv->chip_cat == OCEANUS_CATEGORY){
				hw_priv->hw->wiphy->bands[IEEE80211_BAND_5GHZ] = &atbm_band_5ghz;
				...
				hw_priv->hw->wiphy->bands[IEEE80211_BAND_5GHZ] = NULL;
				atbm_printk_always("=>disable 5G beacuse cronus not support\n");
	   }
#endif // (CONFIG_ATBM_5G_PRETEND_2G)
#endif /* CONFIG_ATBM_APOLLO_5GHZ_SUPPORT */
	...
	{
		char buffer[15];
		if(atbm_access_file(PATH_WIFI_EFUSE,buffer,15,1) > 0) {
	...
	*pself = dev->priv;
	...
	/*
     * maybe need keep ps state
     */
    atbm_bus_keep_awake(hw_priv);
...
int atbm_access_file(char *path, char *buffer, int size, int isRead)
{
	...
	atbm_printk_debug("apollo wifi : atbm_access_file return code(%d)\n",ret);
	return ret;
}
#endif
