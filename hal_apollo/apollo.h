...
#include "offload_tcpack.h"

//#define CONFIG_TCP_ACK_OFFLOAD   //1
...
#define RATE_INDEX_VHT_MC0          	38
#define RATE_INDEX_VHT_MC1          	39
#define RATE_INDEX_VHT_MC2          	40
#define RATE_INDEX_VHT_MC3          	41
#define RATE_INDEX_VHT_MC4          	42
#define RATE_INDEX_VHT_MC5          	43
#define RATE_INDEX_VHT_MC6          	44
#define RATE_INDEX_VHT_MC7          	45
#define RATE_INDEX_VHT_MC8          	46
#define RATE_INDEX_VHT_MC9          	47
...
#define CONFIG_ATBM_WIFI4			0//现在是wifi6 芯片驱动
...
//	struct atbm_vendor_cfg_ie private_ie;
	...
	u32 chip_version;
	u32 chip_id;// from 0x0ACC017C[31:0]
	bool loader_ble;
	u8 mi_ver;
	u8 chip_cat;
...
#endif
    u8 single_channel_scan_reduce_time;
	u8 *xmit_buff;
...
extern u32 atbm_hw_priv_chip_id(void);
...
#if CONFIG_ATBM_WIFI4//603x/601x/613x
...
#else //WIFI6 606x/616x

#define EXCAPABILITIES_BLE_50						BIT(0)
#define EXCAPABILITIES_WIFI6						BIT(1)
