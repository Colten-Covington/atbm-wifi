...
struct atbm_common {
	...
	struct atbm_timer_list anker_expire_timer;
	int anker_wtd;
#endif
...
struct atbm_vif {
	...
	/* AP powersave */
	u32			link_id_map;
	struct atbm_link_entry link_id_db[ATBMWIFI_MAX_STA_IN_AP_MODE + 1 + 1];
	u32			sta_asleep_mask;
	u32			pspoll_mask;
	bool			aid0_bit_set;
...
extern void atbm_firmware_cap_int(struct atbm_common *hw_priv);
