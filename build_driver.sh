...
run_compile()
{
	...
	if [ "$1" = "313E" ] || [ "$1" = "313e" ];then
		...
		platform_soc=PLATFORM_325
                ...
                KDIR=/usr/lchome/lishicheng/aipieke/kernel
		CC=/usr/lchome/lishicheng/aipieke/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabihf/bin/arm-linux-gnueabihf-
	        architecture=arm
                system=Linux
        ...
        platform_soc=PLATFORM_FH308
                ...
                KDIR=/usr/lchome/yuzhihuang/rv1106/sololinker/sysdrv/source/kernel
                CC=/usr/lchome/yuzhihuang/rv1106/sololinker/tools/linux/toolchain/arm-rockchip830-linux-uclibcgnueabihf/bin/arm-rockchip830-linux-uclibcgnueabihf-
                architecture=arm
                system=Linux
...
#                CC=/usr/lchome/yanglu/wifi6/hualai/mips-gcc720-uclibc0.9.33.2-r5.1.4/bin/mips-linux-uclibc-
                KDIR=/home/usta/Desktop/c100_SDK/C100_minicamera_SDK/Ingenic-SDK-C100-2.1.0-20231124/opensource/kernel
                CC=/opt/mips-gcc472-glibc216-64bit/bin/mips-linux-gnu-
                architecture=mips
        	system=Linux
