...
#define ATBM_PRINTK_MASK_RATE_CONTROL	BIT(21)
#define ATBM_PRINTK_MASK_LIMIT			BIT(22)
#define ATBM_PRINTK_MASK_BLE			BIT(23)
#define ATBM_PRINTK_MASK_CSA			BIT(24)
#define ATBM_PRINTK_DEFAULT_MASK	(ATBM_PRINTK_MASK_ERR|ATBM_PRINTK_MASK_WARN|ATBM_PRINTK_MASK_INIT| ATBM_PRINTK_MASK_AGG |\
								ATBM_PRINTK_MASK_EXIT|ATBM_PRINTK_MASK_SCAN|ATBM_PRINTK_MASK_LMAC|ATBM_PRINTK_MASK_PM|ATBM_PRINTK_MASK_LIMIT | ATBM_PRINTK_MASK_CSA)
...
#define atbm_printk_rc(...)		    atbm_printk(ATBM_PRINTK_MASK_RATE_CONTROL,__VA_ARGS__)
#define atbm_printk_ble(...)		atbm_printk(ATBM_PRINTK_MASK_BLE,__VA_ARGS__)
#define atbm_printk_csa(...)		atbm_printk(ATBM_PRINTK_MASK_CSA,__VA_ARGS__)
...
#define atbm_printk_once(fmt,arg...)		printk_once(KERN_ERR "%s" fmt,atbm_log,##arg)
#define atbm_printk_limit(fmt,arg...)	do{if((atbm_printk_mask&(ATBM_PRINTK_MASK_LIMIT)) && ieee80211_ratelimit()) printk(KERN_ERR "%s" fmt,atbm_log,##arg);}while(0)
...
#define CONFIG_SUPPORT_HE_MCS_NSS_SET	0xFFFE
...
#endif
#if (LINUX_VERSION_IS_GEQ_OR_CPTCFG(4, 7, 0))
...
extern int beamforming_on;
extern int he_rx_mcs;
extern int he_tx_mcs;
...
#error	"Please fix <asm/byteorder.h>"
	...
	struct	atbm_in6_addr	saddr;
	struct	atbm_in6_addr	daddr;
}__packed;
...
#define ATBM_WLAN_AUTH_FILS_SK 4
#define ATBM_WLAN_AUTH_FILS_SK_PFS 5
#define ATBM_WLAN_AUTH_FILS_PK 6
...
enum atbm_ieee80211_eid {
	...
	ATBM_WLAN_EID_NON_TX_BSSID_CAP =  83,
	ATBM_WLAN_EID_MULTI_BSSID_IDX = 85,
	...
	ATBM_WLAN_EID_ADDBA_EXT = 159,
		
	ATBM_WLAN_EID_QUIET_PERIOD_REQ = 175,
	/* 176 reserved for Symbol */
	ATBM_WLAN_EID_QUIET_PERIOD_RESP = 177,
		
	ATBM_WLAN_EID_VHT_CAPABILITY = 191,
	ATBM_WLAN_EID_VHT_OPERATION = 192,
	ATBM_WLAN_EID_EXTENDED_BSS_LOAD = 193,
	ATBM_WLAN_EID_WIDE_BW_CHANNEL_SWITCH = 194,
	ATBM_WLAN_EID_TX_POWER_ENVELOPE = 195,
	ATBM_WLAN_EID_CHANNEL_SWITCH_WRAPPER = 196,
	ATBM_WLAN_EID_AID = 197,
	ATBM_WLAN_EID_QUIET_CHANNEL = 198,
    ATBM_WLAN_EID_OP_MODE_NOTIFICATION = 199,
	ATBM_WLAN_EID_AID_REQUEST = 210,
	ATBM_WLAN_EID_AID_RESPONSE = 211,
	...
	ATBM_WLAN_EID_S1G_TWT = 216,
	ATBM_WLAN_EID_EXTENSION = 255,

};
/* Element ID Extensions for Element ID 255 */

enum atbm_ieee80211_eid_ext {
	ATBM_WLAN_EID_EXT_ASSOC_DELAY_INFO = 1,
	ATBM_WLAN_EID_EXT_FILS_REQ_PARAMS = 2,
	ATBM_WLAN_EID_EXT_FILS_KEY_CONFIRM = 3,
	ATBM_WLAN_EID_EXT_FILS_SESSION = 4,
	ATBM_WLAN_EID_EXT_FILS_HLP_CONTAINER = 5,
	ATBM_WLAN_EID_EXT_FILS_IP_ADDR_ASSIGN = 6,
	ATBM_WLAN_EID_EXT_KEY_DELIVERY = 7,
	ATBM_WLAN_EID_EXT_FILS_WRAPPED_DATA = 8,
	ATBM_WLAN_EID_EXT_FILS_PUBLIC_KEY = 12,
	ATBM_WLAN_EID_EXT_FILS_NONCE = 13,
	ATBM_WLAN_EID_EXT_FUTURE_CHAN_GUIDANCE = 14,
	ATBM_WLAN_EID_EXT_HE_CAPABILITY = 35,
	ATBM_WLAN_EID_EXT_HE_OPERATION = 36,
	ATBM_WLAN_EID_EXT_UORA = 37,
	ATBM_WLAN_EID_EXT_HE_MU_EDCA = 38,
	ATBM_WLAN_EID_EXT_HE_SPR = 39,
	ATBM_WLAN_EID_EXT_NDP_FEEDBACK_REPORT_PARAMSET = 41,
	ATBM_WLAN_EID_EXT_BSS_COLOR_CHG_ANN = 42,
	ATBM_WLAN_EID_EXT_QUIET_TIME_PERIOD_SETUP = 43,
	ATBM_WLAN_EID_EXT_ESS_REPORT = 45,
	ATBM_WLAN_EID_EXT_OPS = 46,
	ATBM_WLAN_EID_EXT_HE_BSS_LOAD = 47,
	ATBM_WLAN_EID_EXT_MAX_CHANNEL_SWITCH_TIME = 52,
	ATBM_WLAN_EID_EXT_MULTIPLE_BSSID_CONFIGURATION = 55,
	ATBM_WLAN_EID_EXT_NON_INHERITANCE = 56,
	ATBM_WLAN_EID_EXT_KNOWN_BSSID = 57,
	ATBM_WLAN_EID_EXT_SHORT_SSID_LIST = 58,
	ATBM_WLAN_EID_EXT_HE_6GHZ_CAPA = 59,
	ATBM_WLAN_EID_EXT_UL_MU_POWER_CAPA = 60,
};	
...
enum atbm_ieee80211_category {
	...
	ATBM_WLAN_CATEGORY_S1G = 22,
	ATBM_WLAN_CATEGORY_VENDOR_SPECIFIC_PROTECTED = 126,
	ATBM_WLAN_CATEGORY_VENDOR_SPECIFIC = 127,
};
enum atbm_ieee80211_s1g_actioncode {
	ATBM_WLAN_S1G_AID_SWITCH_REQUEST,
	ATBM_WLAN_S1G_AID_SWITCH_RESPONSE,
	ATBM_WLAN_S1G_SYNC_CONTROL,
	ATBM_WLAN_S1G_STA_INFO_ANNOUNCE,
	ATBM_WLAN_S1G_EDCA_PARAM_SET,
	ATBM_WLAN_S1G_EL_OPERATION,
	ATBM_WLAN_S1G_TWT_SETUP,
	ATBM_WLAN_S1G_TWT_TEARDOWN,
	ATBM_WLAN_S1G_SECT_GROUP_ID_LIST,
	ATBM_WLAN_S1G_SECT_ID_FEEDBACK,
	ATBM_WLAN_S1G_TWT_INFORMATION = 11,
};
#define ATBM_IEEE80211_TWT_CONTROL_NDP			BIT(0)
#define ATBM_IEEE80211_TWT_CONTROL_RESP_MODE			BIT(1)
#define ATBM_IEEE80211_TWT_CONTROL_NEG_TYPE_BROADCAST	BIT(3)
#define ATBM_IEEE80211_TWT_CONTROL_RX_DISABLED		BIT(4)
#define ATBM_IEEE80211_TWT_CONTROL_WAKE_DUR_UNIT		BIT(5)
/* Status codes */
...
#define ATBM_IEEE80211_TWT_REQTYPE_REQUEST			BIT(0)
#define ATBM_IEEE80211_TWT_REQTYPE_SETUP_CMD			GENMASK(3, 1)
#define ATBM_IEEE80211_TWT_REQTYPE_TRIGGER			BIT(4)
#define ATBM_IEEE80211_TWT_REQTYPE_IMPLICIT			BIT(5)
#define ATBM_IEEE80211_TWT_REQTYPE_FLOWTYPE			BIT(6)
#define ATBM_IEEE80211_TWT_REQTYPE_FLOWID			GENMASK(9, 7)
#define ATBM_IEEE80211_TWT_REQTYPE_WAKE_INT_EXP		GENMASK(14, 10)
#define ATBM_IEEE80211_TWT_REQTYPE_PROTECTION		BIT(15)

enum atbm_ieee80211_twt_setup_cmd {
	ATBM_TWT_SETUP_CMD_REQUEST,
	ATBM_TWT_SETUP_CMD_SUGGEST,
	ATBM_TWT_SETUP_CMD_DEMAND,
	ATBM_TWT_SETUP_CMD_GROUPING,
	ATBM_TWT_SETUP_CMD_ACCEPT,
	ATBM_TWT_SETUP_CMD_ALTERNATE,
	ATBM_TWT_SETUP_CMD_DICTATE,
	ATBM_TWT_SETUP_CMD_REJECT,
};
struct ieee80211_twt_request_params{
...
struct atbm_ieee80211_twt_setup {
	u8 dialog_token;
	u8 element_id;
	u8 length;
	u8 control;
...
struct atbm_ieee80211_twt_setup_request{
	u8 dialog_token;
	u8 element_id;
	u8 length;
	u8 control;
...
struct atbm_ieee80211_twt_params {
	__le16 req_type;
	__le64 twt;
	u8 min_twt_dur;
	__le16 mantissa;
...
enum ieee80211_sta_twt_state {
	STA_TWT_STATE_IDLE,
	STA_TWT_STATE_REQUEST,
	STA_TWT_STATE_SUGGEST,
	STA_TWT_STATE_DEMAND,
	STA_TWT_STATE_REJECT,
	STA_TWT_STATE_ACCEPT,
	STA_TWT_STATE_SP_START,
	STA_TWT_STATE_SP_INTERVAL,
};
enum ieee80211_sta_twt_suspend_state{
	STA_TWT_SUSPEND_STATE_IDLE,
	STA_TWT_SUSPEND_STATE_WAIT_ANCHOR,
	STA_TWT_SUSPEND_STATE_WAIT_SP_START_SETP1,
	STA_TWT_SUSPEND_STATE_WAIT_SP_START_SETP2,
	STA_TWT_SUSPEND_STATE_SP_START,
	STA_TWT_SUSPEND_STATE_SP_INTERVAL_PREPARE,
	STA_TWT_SUSPEND_STATE_SP_INTERVAL_CHANGE_PS,
	STA_TWT_SUSPEND_STATE_SP_INTERVAL,	
};
...
/**
 * struct atbm_ieee80211_bss_max_idle_period_ie
 *
...
#if (LINUX_VERSION_IS_GEQ_OR_CPTCFG(3, 4, 0))
...
/**
 * struct atbm_ieee80211_channel_sw_ie
 *
...
struct atbm_ieee80211_channel_sw_packed_ie{
	struct atbm_ieee80211_channel_sw_ie *chan_sw_ie;
...
enum atbm_ieee80211_spectrum_mgmt_actioncode {
		...
		struct {
			...
			union {
				...
				struct {
					...
					__le16 mantissa;
					u8 channel;
				}__packed s1g_twt_request_target;
				struct {
					u8 action_code;
					u8 dialog_token;
					u8 twt_id;
					...
					__le16 mantissa;
					u8 channel;
				}__packed s1g_twt_request;
			} u;
		} __attribute__ ((packed)) action;
	} u;
} __attribute__ ((packed));

#define ATBM_IEEE80211_MIN_ACTION_SIZE ((int)offsetof(struct atbm_ieee80211_mgmt, u.action.u))
...
struct atbm_ieee80211_he_mu_edca_param_ac_rec {
	u8 aifsn;
	u8 ecw_min_max;
	u8 mu_edca_timer;
} __packed;
...
/**
 * struct atbm_ieee80211_ht_info - HT information
 *
 * This structure is the "HT information element" as
 * described in 802.11n D5.0 7.3.2.58
 */
struct atbm_ieee80211_ht_info {
	u8 control_chan;
	u8 ht_param;
...
/**
 * struct atbm_ieee80211_mcs_info - MCS information
 * @rx_mask: RX mask
 ...
 */
struct atbm_ieee80211_mcs_info {
	u8 rx_mask[ATBM_IEEE80211_HT_MCS_MASK_LEN];
	__le16 rx_highest;
	u8 tx_params;
	u8 reserved[3];
} __packed;
 ...
 */
struct atbm_ieee80211_ht_cap {
	__le16 cap_info;
	u8 ampdu_params_info;

	/* 16 bytes MCS information */
	struct atbm_ieee80211_mcs_info mcs;
 ...
 */
enum atbm_ieee80211_sta_rx_bandwidth {
	ATBM_IEEE80211_STA_RX_BW_20 = 0,
	ATBM_IEEE80211_STA_RX_BW_40,
	ATBM_IEEE80211_STA_RX_BW_80,
	ATBM_IEEE80211_STA_RX_BW_160,
};
...
#define ATBM_IEEE80211_VHT_CAP_MAX_MPDU_LENGTH_3895			0x00000000
#define ATBM_IEEE80211_VHT_CAP_MAX_MPDU_LENGTH_7991			0x00000001
#define ATBM_IEEE80211_VHT_CAP_MAX_MPDU_LENGTH_11454			0x00000002
#define ATBM_IEEE80211_VHT_CAP_MAX_MPDU_MASK				0x00000003
#define ATBM_IEEE80211_VHT_CAP_SUPP_CHAN_WIDTH_160MHZ		0x00000004
#define ATBM_IEEE80211_VHT_CAP_SUPP_CHAN_WIDTH_160_80PLUS80MHZ	0x00000008
#define ATBM_IEEE80211_VHT_CAP_SUPP_CHAN_WIDTH_MASK			0x0000000C
#define ATBM_IEEE80211_VHT_CAP_SUPP_CHAN_WIDTH_SHIFT			2
#define ATBM_IEEE80211_VHT_CAP_RXLDPC				0x00000010
#define ATBM_IEEE80211_VHT_CAP_SHORT_GI_80				0x00000020
#define ATBM_IEEE80211_VHT_CAP_SHORT_GI_160				0x00000040
#define ATBM_IEEE80211_VHT_CAP_TXSTBC				0x00000080
#define ATBM_IEEE80211_VHT_CAP_RXSTBC_1				0x00000100
#define ATBM_IEEE80211_VHT_CAP_RXSTBC_2				0x00000200
#define ATBM_IEEE80211_VHT_CAP_RXSTBC_3				0x00000300
#define ATBM_IEEE80211_VHT_CAP_RXSTBC_4				0x00000400
#define ATBM_IEEE80211_VHT_CAP_RXSTBC_MASK				0x00000700
#define ATBM_IEEE80211_VHT_CAP_RXSTBC_SHIFT				8
#define ATBM_IEEE80211_VHT_CAP_SU_BEAMFORMER_CAPABLE			0x00000800
#define ATBM_IEEE80211_VHT_CAP_SU_BEAMFORMEE_CAPABLE			0x00001000
#define ATBM_IEEE80211_VHT_CAP_BEAMFORMEE_STS_SHIFT                  13
#define ATBM_IEEE80211_VHT_CAP_BEAMFORMEE_STS_MASK			\
		(7 << ATBM_IEEE80211_VHT_CAP_BEAMFORMEE_STS_SHIFT)
#define ATBM_IEEE80211_VHT_CAP_SOUNDING_DIMENSIONS_SHIFT		16
#define ATBM_IEEE80211_VHT_CAP_SOUNDING_DIMENSIONS_MASK		\
		(7 << ATBM_IEEE80211_VHT_CAP_SOUNDING_DIMENSIONS_SHIFT)
#define ATBM_IEEE80211_VHT_CAP_MU_BEAMFORMER_CAPABLE			0x00080000
#define ATBM_IEEE80211_VHT_CAP_MU_BEAMFORMEE_CAPABLE			0x00100000
#define ATBM_IEEE80211_VHT_CAP_VHT_TXOP_PS				0x00200000
#define ATBM_IEEE80211_VHT_CAP_HTC_VHT				0x00400000
#define ATBM_IEEE80211_VHT_CAP_MAX_A_MPDU_LENGTH_EXPONENT_SHIFT	23
#define ATBM_IEEE80211_VHT_CAP_MAX_A_MPDU_LENGTH_EXPONENT_MASK	\
		(7 << ATBM_IEEE80211_VHT_CAP_MAX_A_MPDU_LENGTH_EXPONENT_SHIFT)
#define ATBM_IEEE80211_VHT_CAP_VHT_LINK_ADAPTATION_VHT_UNSOL_MFB	0x08000000
#define ATBM_IEEE80211_VHT_CAP_VHT_LINK_ADAPTATION_VHT_MRQ_MFB	0x0c000000
#define ATBM_IEEE80211_VHT_CAP_RX_ANTENNA_PATTERN			0x10000000
#define ATBM_IEEE80211_VHT_CAP_TX_ANTENNA_PATTERN			0x20000000
#define ATBM_IEEE80211_VHT_CAP_EXT_NSS_BW_SHIFT			30
#define ATBM_IEEE80211_VHT_CAP_EXT_NSS_BW_MASK			0xc0000000
/* for rx_highest */
#define ATBM_IEEE80211_VHT_MAX_NSTS_TOTAL_SHIFT	13
#define ATBM_IEEE80211_VHT_MAX_NSTS_TOTAL_MASK	(7 << IEEE80211_VHT_MAX_NSTS_TOTAL_SHIFT)

/* for tx_highest */
#define ATBM_IEEE80211_VHT_EXT_NSS_BW_CAPABLE	(1 << 13)


/**
 * struct atbm_ieee80211_vht_operation - VHT operation IE
 *
 ...
 */
struct atbm_ieee80211_vht_operation {
	u8 chan_width;
...
/**
 * struct atbm_ieee80211_vht_mcs_info - VHT MCS information
 ...
 *	Capability.
 */
struct atbm_ieee80211_vht_mcs_info {
	__le16 rx_mcs_map;
	__le16 rx_highest;
	__le16 tx_mcs_map;
	__le16 tx_highest;
...
/**
 * struct atbm_ieee80211_vht_cap - VHT capabilities
 *
 ...
 */
struct atbm_ieee80211_vht_cap {
	__le32 vht_cap_info;
	struct atbm_ieee80211_vht_mcs_info supp_mcs;
} __packed;
/**
 * enum atbm_ieee80211_vht_mcs_support - VHT MCS support definitions
 * @ATBM_IEEE80211_VHT_MCS_SUPPORT_0_7: MCSes 0-7 are supported for the
 *	number of streams
 * @ATBM_IEEE80211_VHT_MCS_SUPPORT_0_8: MCSes 0-8 are supported
 * @ATBM_IEEE80211_VHT_MCS_SUPPORT_0_9: MCSes 0-9 are supported
 * @ATBM_IEEE80211_VHT_MCS_NOT_SUPPORTED: This number of streams isn't supported
 *
 ...
 * for.
 */
enum atbm_ieee80211_vht_mcs_support {
	ATBM_IEEE80211_VHT_MCS_SUPPORT_0_7	= 0,
	ATBM_IEEE80211_VHT_MCS_SUPPORT_0_8	= 1,
	ATBM_IEEE80211_VHT_MCS_SUPPORT_0_9	= 2,
	ATBM_IEEE80211_VHT_MCS_NOT_SUPPORTED	= 3,
};
...
#define ATBM_IEEE80211_ADDBA_EXT_NO_FRAG		BIT(0)
...
static inline int atbm_ieee80211_he_mcs_rate_support(__le16 mcs_map,u8 nss)
{
	u16 mcs_mask = le16_to_cpu(mcs_map) >> ((nss-1)*2);
	return 	(mcs_mask & 0x03) != ATBM_IEEE80211_HE_MCS_NOT_SUPPORTED;
}
static inline u8 atbm_ieee80211_he_mcs_operation_rate(__le16 mcs_map,u8 nss)
{
	u16 mcs_mask = le16_to_cpu(mcs_map) >> ((nss-1)*2);
 ...
 */
static inline u8
atbm_ieee80211_he_ppe_size(u8 ppe_thres_hdr, const u8 *phy_cap_info)
{
	u8 n;
 ...
 * of "IEEE Std 802.11ax™�?021", the max power level is 8.
 */
...
struct atbm_ieee80211_tx_pwr_env {
	u8 tx_power_info;
	s8 tx_power[ATBM_IEEE80211_TPE_MAX_POWER_COUNT];
} __packed;
 ...
 */
static inline u8
atbm_ieee80211_he_oper_size(const u8 *he_oper_ie)
{
	struct atbm_ieee80211_he_operation *he_oper = (void *)he_oper_ie;
	u8 oper_len = sizeof(struct atbm_ieee80211_he_operation);
	u32 he_oper_params;
...
#define ATBM_IEEE80211_HE_SPR_PSR_DISALLOWED				BIT(0)
#define ATBM_IEEE80211_HE_SPR_NON_SRG_OBSS_PD_SR_DISALLOWED		BIT(1)
#define ATBM_IEEE80211_HE_SPR_NON_SRG_OFFSET_PRESENT			BIT(2)
#define ATBM_IEEE80211_HE_SPR_SRG_INFORMATION_PRESENT		BIT(3)
#define ATBM_IEEE80211_HE_SPR_HESIGA_SR_VAL15_ALLOWED		BIT(4)
 ...
 */
static inline u8
atbm_ieee80211_he_spr_size(const u8 *he_spr_ie)
{
	struct atbm_ieee80211_he_spr *he_spr = (void *)he_spr_ie;
	u8 spr_len = sizeof(struct atbm_ieee80211_he_spr);
	u8 he_spr_params;
...
struct atbm_ieee80211_sta_he_cap {
	...
	u8 ppe_thres[ATBM_IEEE80211_HE_PPE_THRES_MAX_LEN];
...
/**
 * struct atbm_ieee80211_sta_ht_cap - STA's HT capabilities
 *
 * This structure describes most essential parameters needed
 ...
 */
struct atbm_ieee80211_sta_ht_cap {
...
enum mac80211_tx_control_flags
{
	...
	IEEE80211_TX_CTL_QOS = BIT(8),
	IEEE80211_TX_STAT_ACK = BIT(9),
	IEEE80211_TX_CTL_8023 = BIT(10),
	IEEE80211_TX_UCAST    = BIT(11),
	IEEE80211_TX_CTL_MORE	  = BIT(12),
	IEEE80211_TX_2BYTTES_OFF             = BIT(13),
	IEEE80211_TX_INTFL_NEED_TXPROCESSING = BIT(14),
	IEEE80211_TX_CTL_EOSP				 = BIT(15),
    ...
    IEEE80211_TX_FIXED_RATE         = BIT(22),
    IEEE80211_TX_CTL_AMSDU          = BIT(23),
    IEEE80211_TX_CTL_AMSDU_END      = BIT(24),
...
#define IEEE80211_TX_ENCAP_AMSDU_MASK  (IEEE80211_TX_CTL_QOS | IEEE80211_TX_CTL_8023)
/*
 ...
 *
 * @IEEE80211_TX_RC_VHT_LDPC: VHT tx can Use LDPC.
...
enum mac80211_rate_control_flags {
	ATBM_IEEE80211_TX_RC_VHT_LDPC		= BIT(0),
	...
	ATBM_IEEE80211_TX_RC_SHORT_GI_40M		= BIT(4),
	ATBM_IEEE80211_TX_RC_40_MHZ_WIDTH		= BIT(5),
	//IEEE80211_TX_RC_DUP_DATA		= BIT(6),
	ATBM_IEEE80211_TX_RC_SHORT_GI		= BIT(7),
    ATBM_IEEE80211_TX_RC_HE_MCS			= BIT(6),


	ATBM_IEEE80211_TX_RC_HT_LDPC			= BIT(8),
	ATBM_IEEE80211_TX_RC_HE_LDPC			= BIT(9),
	ATBM_IEEE80211_TX_RC_HE_DCM			= BIT(10),  //set DCM
	ATBM_IEEE80211_TX_RC_HE_ER			= BIT(11),
	ATBM_IEEE80211_TX_RC_40M_TO_20M		= BIT(12),  //set main 20M of 40M bandwidth
	ATBM_IEEE80211_TX_RC_20_MHZ_WIDTH    = BIT(13),  //support 20M of 40M bandwidth.
	ATBM_IEEE80211_TX_RC_HE_SUPPORT_DCM	= BIT(14),  //support DCM
	ATBM_IEEE80211_TX_RC_SHORT_GI_20M	= BIT(15)
...
/*tick*/
static inline unsigned long  atbm_GetOsTick(void)
{
  return jiffies;
}
...
enum ieee80211_rate_hw_flags{
	IEEE80211_RATE_HW_FLAGS_UNMAP = BIT(0),
};
static inline bool ieee80211_rate_unmap(struct ieee80211_rate *rate)
{
	return !!(rate->hw_value_short & IEEE80211_RATE_HW_FLAGS_UNMAP);
}
...
#define HE_MODE_DOWN_TO_11B  (BIT(0))
 ...
 */
 /*the max size of the ieee80211_tso_info is 8 bytes*/
struct ieee80211_tso_info{
	u32 offset;
	u16 n_mss;
	u8  network_len;
	u8  transport_len;
};
struct ieee80211_amsdu_frags{
    struct sk_buff *tail;
};
struct ieee80211_amsdu_len{
    u16 total_len;
    u16 head_len;
};
...
struct atbm_tx_rc_output
{
    u32 tx_rate_sets;
	u8	tx_max_rate;
	u8	force_policyid;  // bit[4:6] set forced policy id
	u16 tx_rc_flag;	
};
	...
	union
	{
		struct {
			union {
				...
				struct ieee80211_tso_info tso;
                struct ieee80211_amsdu_frags amsdu;
			};
            struct ieee80211_amsdu_len amsdu_len;
			
			struct atbm_tx_rc_output txrc_out; //8bytes
			//u32 tx_rate_sets;
			//u8  tx_max_rate;
			//u8  force_policyid;  // bit[4:6] set forced policy id
			//u16 tx_rc_flag;
...
enum mac80211_rx_flags {
	...
	RX_FLAG_8023  = 1<<17,
	RX_FLAG_HE_AP = 1<<18,
	RX_FLAG_QOS_DUP = 1<<19,
	RX_FLAG_HE		= 1<<20,
	RX_FLAG_HE_ER	= 1<<21,
	RX_FLAG_11G	= 1<<22,
    RX_FLAG_VHT = 1<<23,
    RX_FLAG_MULTICAST = 1<<24,
};

#define RX_FLAG_MCS_MASK (RX_FLAG_HT | RX_FLAG_HE | RX_FLAG_HE_ER | RX_FLAG_VHT)

#ifdef  CONFIG_SUPPORT_80M_ADAPTER
/**atbm_80M_adapter*/
#define ATBM_ADAPTER_DISABLE	 0
#define ATBM_ADAPTER_LMAC 		 BIT(0)
#define ATBM_ADAPTER_HMAC 		 BIT(1)
#define ATBM_ADAPTER_HMAC_LMAC   (ATBM_ADAPTER_LMAC|ATBM_ADAPTER_HMAC)
...
#define ATBM_WLAN_EXT_CAPA10_TWT_REQUESTER_SUPPORT	BIT(5)
#define ATBM_WLAN_EXT_CAPA10_TWT_RESPONDER_SUPPORT	BIT(6)
...
struct ieee80211_hw {
	...
	struct wiphy *wiphy;
#ifdef CONFIG_ATBM_HE
	struct atbm_ieee80211_sta_he_cap *he_cap_2g4;
	struct atbm_ieee80211_sta_he_cap *he_cap_5g;
#endif
    struct atbm_ieee80211_sta_vht_cap *vht_cap_2g4;
    struct atbm_ieee80211_sta_vht_cap *vht_cap_5g;
...
static inline bool atbm_ieee80211_vht_supported(struct ieee80211_hw *hw,struct ieee80211_supported_band *sband)
{
    ...
    if(vht_cap){
        return vht_cap->vht_supported;
    }

    return false;
}

#define IEEE80211_ATBM_MAX_SCAN_CHANNEL_INDEX		256
enum ieee80211_scan_req_wrap_flags{
	...
	IEEE80211_SCAN_REQ_RADAR_DETECT    = 1<<14,
};
...
struct ieee80211_scan_req_wrap{
	...
	u8  radar_exist[IEEE80211_ATBM_MAX_SCAN_CHANNEL_INDEX];
};
/**
...
struct ieee80211_ops {
	...
	int (*conf_tx)(struct ieee80211_hw *hw,
		       ...
		       const struct atbm_ieee80211_tx_queue_params *params);
...
#endif
	int (*do_twt)(struct ieee80211_vif *vif,struct ieee80211_sta *sta,struct ieee80211_twt_request_params *twt_params,bool enable);
#ifdef CONFIG_ATBM_SUPPORT_CSA
	int (*do_csa)(struct ieee80211_vif *vif,struct ieee80211_csa_request *request);
#endif
	int (*do_csa_concurrent)(struct ieee80211_hw *hw,struct list_head *list);
    int (*do_change_dcm)(struct ieee80211_hw *hw);
};
...
#endif
#endif
extern bool ieee80211_support_ht_40M(void);
extern bool ieee80211_support_vht_40M(void);
extern bool ieee80211_support_he_40M(void);
/**
...
void ieee80211_queue_delayed_work(struct ieee80211_hw *hw,
				  ...
				  unsigned long delay);
void ieee80211_rx_8023(struct ieee80211_hw *hw,struct ieee80211_sta *pubsta,struct sk_buff *skb);
...
struct rate_control_ops {
	...
	void (*tx_status)(void *priv, struct ieee80211_supported_band *sband,
			  struct ieee80211_sta *sta, void *priv_sta,
			  struct sk_buff *skb);
	void (*rx_status)(void *priv, struct ieee80211_supported_band *sband,
			  struct ieee80211_sta *sta, void *priv_sta,
			  struct sk_buff *skb);
	...
	void (*hmac_tx_status)(void *priv,struct ieee80211_sta *sta, void *priv_sta);
};
...
struct atbm_rate_control_ops {
	struct module *module;
	const char *name;
	void *(*alloc)(u8 chip_cat);
	void (*free)(void *priv);

    /*parameters 
    output: sta: n_rates, tx_status_buffer(txs_retrys) to sta.
    */
	void *(*alloc_sta)(void *priv, struct atbm_ieee80211_sta *sta, gfp_t gfp);

    /*parameters
      sta:    input ht/he/vht caps, chip category.
      sband:  input center freq and channel type
    */
	void (*rate_init)(void *priv, struct atbmwifi_band_info *sband,
      ...
      sta:    input ht/he/vht caps, chip category.
      sband:  input center freq and channel type
      can reduce 2 parameters????
    */          
	void (*rate_update)(void *priv, struct atbmwifi_band_info *sband,
			    struct atbm_ieee80211_sta *sta,
			    void *priv_sta, u32 changed,
	...
	void (*free_sta)(void *priv,  void *priv_sta);
     //not used
	void (*tx_status)(void *priv, struct atbmwifi_band_info *sband,
			  struct atbm_ieee80211_sta *sta, void *priv_sta,
			  struct sk_buff *skb);

              
	void (*rx_status)(void *priv, void *priv_sta,			  
			  struct atbmn_ieee80211_rx_status *rx_status);
      ...
      output
      txrc:  rate control infomation
     */            
	void (*get_rate)(void *priv, void *priv_sta,
	...
	void (*remove_sta_debugfs)(void *priv, void *priv_sta);
     ...
     /*parameters
      input
      sta:  ht/he/vht caps, chip category, txs_retrys.    
     */          
	void (*hmac_tx_status)(void *priv,struct atbm_ieee80211_sta *sta, void *priv_sta);
};
...
//bool atbm_rate_control_send_low(struct atbm_ieee80211_sta *sta,
	//		   void *priv_sta,
	//		   struct atbm_ieee80211_tx_rate_control *txrc);
...
int ieee80211_build_80211_frame(struct ieee80211_build_frame *build_encap);
static inline bool
...
static inline int atbm_mod_timer_pending(struct atbm_timer_list *atbm_timer, unsigned long expires)
{
	int ret = 0;

	ret = mod_timer_pending(&atbm_timer->timer,expires);
...
extern int ieee80211_ratelimit(void);
...
static inline bool ieee80211_opclass_to_band(u8 operating_class,
				       enum ieee80211_band *band)
{
...
//0.5 -- > 5
static inline bool atbm_accsii_to_10Xfloat(const char *pos,int len,int *res)
{
	int res_val = 0;
	int index = 0;
	bool neg = false;
...
#define atbm_for_each_element(_elem, _data, _datalen)			\
for (_elem = (const struct atbm_element *)(_data);			\
	 (const u8 *)(_data) + (_datalen) - (const u8 *)_elem >=	\
	(int)sizeof(*_elem) &&					\
	 (const u8 *)(_data) + (_datalen) - (const u8 *)_elem >=	\
	(int)sizeof(*_elem) + _elem->datalen;			\
	 _elem = (const struct atbm_element *)(_elem->data + _elem->datalen))

#define atbm_for_each_element_id(element, _id, data, datalen)		\
atbm_for_each_element(element, data, datalen)			\
	if (element->id == (_id))
									
#define atbm_for_each_element_extid(element, extid, _data, _datalen)		\
atbm_for_each_element(element, _data, _datalen)			\
	if (element->id == ATBM_WLAN_EID_EXTENSION &&		\
		element->datalen > 0 && 			\
		element->data[0] == (extid))
									
#define atbm_for_each_subelement(sub, element)				\
atbm_for_each_element(sub, (element)->data, (element)->datalen)
									
#define atbm_for_each_subelement_id(sub, id, element)			\
atbm_for_each_element_id(sub, id, (element)->data, (element)->datalen)
									
#define atbm_for_each_subelement_extid(sub, extid, element)			\
atbm_for_each_element_extid(sub, extid, (element)->data, (element)->datalen)

static const struct atbm_element *
ieee80211_find_elem_match(u8 eid, const u8 *ies, unsigned int len,
...
static inline const struct atbm_element *ieee80211_find_elem(u8 eid, const u8 *ies, int len)
{
	return ieee80211_find_elem_match(eid, ies, len, NULL, 0, 0);
}

static inline const struct atbm_element *
ieee80211_find_ext_elem(u8 ext_eid, const u8 *ies, int len)
{
	return ieee80211_find_elem_match(ATBM_WLAN_EID_EXTENSION, ies, len,
					&ext_eid, 1, 0);
}

/**
 * atbm_ether_addr_to_u64 - Convert an Ethernet address into a u64 value.
 * @addr: Pointer to a six-byte array containing the Ethernet address
 *
 * Return a u64 value of the address
 */
static inline u64 atbm_ether_addr_to_u64(const u8 *addr)
{
	u64 u = 0;
	int i;
...
/**
 * atbm_u64_to_ether_addr - Convert a u64 to an Ethernet address.
 * @u: u64 to convert to an Ethernet MAC address
 * @addr: Pointer to a six-byte array to contain the Ethernet address
 */
static inline void atbm_u64_to_ether_addr(u64 u, u8 *addr)
{
	int i;
...
#define TX_RATE_FIXED               BIT(0)
#define TX_RATE_FIXED_AUTO_DOWN     BIT(1)
#define TX_RATE_FIXED_STATIC    	BIT(2)
